...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-zngroupsassetmanager
schema: 2.0.0
---
...
```
Update-ZNGroupsAssetManager -GroupId <String> -GroupType <String> -ManagerId <String> -Permission <Int32>
