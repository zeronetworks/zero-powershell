...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znusermfainboundpoliciesdestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNUserMfaInboundPoliciesDestinationCandidate -UserId <String> [-AccountName <String>] [-Limit <Int32>]
