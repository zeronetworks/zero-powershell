...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znswitchrulesdistribution
schema: 2.0.0
---

# Get-ZNSwitchRulesDistribution
...
```
Get-ZNSwitchRulesDistribution -RuleId <String> -SwitchId <String> -RuleDirection <Int32>
