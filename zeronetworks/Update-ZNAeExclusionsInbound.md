...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znaeexclusionsinbound
schema: 2.0.0
---
...
```
Update-ZNAeExclusionsInbound -RuleId <String> [-AccountName <String>] [-Action <String>]
