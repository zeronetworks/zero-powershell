...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-zngroupsmfaidentitypoliciesdestinationcandidate
schema: 2.0.0
---
...
(Get-ZNGroupsMfaIdentityPoliciesDestinationCandidate -Groupid $group.id -GroupType tag).Items
```
