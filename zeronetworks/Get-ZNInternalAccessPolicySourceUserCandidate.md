...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-zninternalaccesspolicysourceusercandidate
schema: 2.0.0
---

# Get-ZNInternalAccessPolicySourceUserCandidate
...
```
Get-ZNInternalAccessPolicySourceUserCandidate [-AccountName <String>] [-Limit <Int32>] [-Offset <Int32>]
