...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/Approve-ZNAssetOutboundRuleReview
schema: 2.0.0
---
...
```
Approve-ZNAssetOutboundRuleReview -AssetId <String> -RuleId <String> [-AccountName <String>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ApproveWithChangesExpanded
```
Approve-ZNAssetOutboundRuleReview -AssetId <String> -RuleId <String> -Reason <Object> [-AccountName <String>]
