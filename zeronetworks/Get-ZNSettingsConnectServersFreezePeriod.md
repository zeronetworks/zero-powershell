...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znsettingsconnectserversfreezeperiod
schema: 2.0.0
---

# Get-ZNSettingsConnectServersFreezePeriod
...
```
Get-ZNSettingsConnectServersFreezePeriod [-AccountName <String>] [<CommonParameters>]
```
