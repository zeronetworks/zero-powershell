...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znassetotoutboundotrule
schema: 2.0.0
---
...
```
Update-ZNAssetOtOutboundOtrule -AssetId <String> -RuleId <String> [-AccountName <String>] [-Action <String>]
...
```powershell
Update-ZNAssetOtOutboundOtrule -AssetId a:t:ffPDi031 -RuleId R:s:v707Sd2y -Description "New Description"
```
