...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-zngroupsoutboundotrulesexcludedsourcecandidate
schema: 2.0.0
---
...
```
Get-ZNGroupsOutboundOtRulesExcludedSourceCandidate -GroupId <String> -GroupType <String>
...
### Example 1: List excluded source candidates for an Outbound OT rules
```powershell
