...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znassetnetworkactivitiesdistinctvalue
schema: 2.0.0
---
...
```
Get-ZNAssetNetworkActivitiesDistinctValue -AssetId <String> -FieldName <String> [-AccountName <String>]
