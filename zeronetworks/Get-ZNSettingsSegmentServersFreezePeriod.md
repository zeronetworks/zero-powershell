...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znsettingssegmentserversfreezeperiod
schema: 2.0.0
---

# Get-ZNSettingsSegmentServersFreezePeriod
...
```
Get-ZNSettingsSegmentServersFreezePeriod [-AccountName <String>] [<CommonParameters>]
```
