...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znoutboundotrule
schema: 2.0.0
---
...
```
Update-ZNOutboundOtrule -RuleId <String> [-AccountName <String>] [-Action <String>] [-Description <String>]
...
```powershell
Update-ZNOutboundOtrule -RuleId R:s:v707Sd2y -Description "New Description"
```
