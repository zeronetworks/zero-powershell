...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znsettingsclientsinternetaccess
schema: 2.0.0
---

# Update-ZNSettingsClientsInternetAccess
...
```
Update-ZNSettingsClientsInternetAccess [-AccountName <String>] [-Trusted <IPortsListItem[]>]
 [-Untrusted <IPortsListItem[]>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
