...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/tree/master/src/help/zeronetworks/update-zninternalaccesspolicy
schema: 2.0.0
---

# Update-ZNInternalAccessPolicy
...
```
Update-ZNInternalAccessPolicy -PolicyId <String> [-AccountName <String>] [-Description <String>]
 [-DstPortsList <IPortsListItem[]>] [-DstProcessNamesList <String[]>] [-Name <String>] [-RuleDuration <Int32>]
 [-SrcUserIdsList <String[]>] [-State <Int32[]>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### ZeroNetworks.PowerShell.Cmdlets.Api.Models.InternalAccessPolicyItem
