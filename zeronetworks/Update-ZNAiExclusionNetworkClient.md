...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znaiexclusionnetworkclient
schema: 2.0.0
---
...
```
Update-ZNAiExclusionNetworkClient [-AccountName <String>] [-Icmp] [-ProcessesList <String[]>]
