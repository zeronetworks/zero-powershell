...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znk8sclusterlabelinboundrule
schema: 2.0.0
---

# Get-ZNK8SClusterLabelInboundRule
...
```
Get-ZNK8SClusterLabelInboundRule -K8SClusterId <String> -Label <String> [-AccountName <String>]
