...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/Approve-ZNInboundRuleReview
schema: 2.0.0
---
...
```
Approve-ZNInboundRuleReview -RuleId <String> [-AccountName <String>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ApproveWithChangesExpanded
```
Approve-ZNInboundRuleReview -RuleId <String> -Reason <Object> [-AccountName <String>] [-Action <Int32>]
...
```powershell
Approve-ZNInboundRuleReview -RuleId '9d275288-4fc3-46e5-a5a0-ff0626214b87'
```
...
```powershell
Approve-ZNInboundRuleReview -RuleId 'e4a170be-c192-414a-9d36-380a4483583a' -Description "new description" -Reason "Other" -Details "add description"
```
