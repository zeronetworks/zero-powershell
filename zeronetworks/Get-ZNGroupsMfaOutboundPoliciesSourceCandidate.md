...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-zngroupsmfaoutboundpoliciessourcecandidate
schema: 2.0.0
---
...
(Get-ZNGroupsMfaOutboundPoliciesSourceCandidate -Groupid $group.id -GroupType tag).Items        
```
