...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znassetmfainboundpoliciesexcludedsourcecandidate
schema: 2.0.0
---
...
```
Get-ZNAssetMfaInboundPoliciesExcludedSourceCandidate -AssetId <String> [-AccountName <String>]
...
### Example 1: List excluded source candidates for inbound MFA policy for a specific asset.
```powershell
$asset = Search-ZNAsset -Fqdn dc01.posh.local
(Get-ZNAssetMfaInboundPoliciesExcludedSourceCandidate -AssetId $asset).Items
```
...
This cmdlet lists the excluded source candidates for an inbound MFA policy for a specific asset.
