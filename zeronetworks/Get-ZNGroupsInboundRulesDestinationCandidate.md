...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-zngroupsinboundrulesdestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNGroupsInboundRulesDestinationCandidate -GroupId <String> -GroupType <String> [-AccountName <String>]
...
(Get-ZNGroupsInboundRulesDestinationCandidate -Groupid $group.id -GroupType tag).Items
```
