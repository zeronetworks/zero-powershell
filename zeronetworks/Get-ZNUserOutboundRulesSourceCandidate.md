...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znuseroutboundrulessourcecandidate
schema: 2.0.0
---
...
### Example 1: List source candidates for a rule
```powershell
$user = (Get-ZNUser -Search zero).Items | where {$_.Name -eq "zero"}
(Get-ZNUserOutboundRulesSourceCandidate -UserId $user.Id).Items
```
...
This cmdlet lists source candidates for a rule.
