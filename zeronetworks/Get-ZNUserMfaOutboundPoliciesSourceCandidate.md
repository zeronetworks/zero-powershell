...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znusermfaoutboundpoliciessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNUserMfaOutboundPoliciesSourceCandidate -UserId <String> [-AccountName <String>] [-Limit <Int32>]
...
(Get-ZNUserMfaOutboundPoliciesSourceCandidate -UserId $user.id).Items
```
