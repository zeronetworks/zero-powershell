...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znassetrpcrulesexcludeddestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNAssetRpcRulesExcludedDestinationCandidate -AssetId <String> [-AccountName <String>] [-Cursor <Int64>]
...
```powershell
(Get-ZNAssetRpcRulesExcludedDestinationCandidate -AssetId 'a:t:itN4uaLX').Items
```
