...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znk8sclusteroutboundnetworkpolicy
schema: 2.0.0
---
...
```
Get-ZNK8SClusterOutboundNetworkPolicy -K8SClusterId <String> [-AccountName <String>] [-Filters <String>]
...
```powershell
(Get-ZNK8SClusterOutboundNetworkPolicy -ClusterId k:c:FYe7yLUJ).Items
```
...
This cmdlet lists the outbound Network policies for a K8s cluster.
