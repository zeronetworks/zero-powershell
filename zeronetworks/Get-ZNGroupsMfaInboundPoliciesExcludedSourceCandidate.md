...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-zngroupsmfainboundpoliciesexcludedsourcecandidate
schema: 2.0.0
---
...
(Get-ZNGroupsMfaInboundPoliciesExcludedSourceCandidate -Groupid $group.id -GroupType tag).Items
```
