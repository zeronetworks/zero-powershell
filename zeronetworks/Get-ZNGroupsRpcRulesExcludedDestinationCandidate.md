...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-zngroupsrpcrulesexcludeddestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNGroupsRpcRulesExcludedDestinationCandidate -GroupId <String> -GroupType <String> [-AccountName <String>]
