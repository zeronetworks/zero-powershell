...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znassetotoutboundotrulesexcludedsourcecandidate
schema: 2.0.0
---
...
```
Get-ZNAssetOtOutboundOtrulesExcludedSourceCandidate -AssetId <String> [-AccountName <String>]
...
### Example 1: List excluded source cadnidates for outbound OT rule 
```powershell
