...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znconnectpoliciessourceuserscandidate
schema: 2.0.0
---

# Get-ZNConnectPoliciesSourceUsersCandidate
...
```
Get-ZNConnectPoliciesSourceUsersCandidate [-AccountName <String>] [-Limit <Int32>] [-Offset <Int32>]
