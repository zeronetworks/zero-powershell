...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/new-znoutboundotrule
schema: 2.0.0
---
...
```
New-ZNOutboundOtRule -Action <Int32> -LocalEntityId <String> -ProtocolsList <ISwitchProtocolsListBodyItem[]>
