...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/new-zninternalaccesspolicy
schema: 2.0.0
---

# New-ZNInternalAccessPolicy
...
```
New-ZNInternalAccessPolicy -DstAssetId <String> -DstPortsList <IPortsListItem[]>
 -DstProcessNamesList <String[]> -Name <String> -RuleDuration <Int32> -SrcUserIdsList <String[]>
 [-AccountName <String>] [-ChangeTicket <String>] [-Description <String>] [-State <Int32>] [-Confirm]
