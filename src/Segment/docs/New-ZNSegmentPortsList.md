...
online version: https://github.com/zn.segment/new-znsegmentportslist
schema: 2.0.0
---

# New-ZNSegmentPortsList
...
```
New-ZNSegmentPortsList -Protocol <String> [-Ports <String>] [<CommonParameters>]
```
