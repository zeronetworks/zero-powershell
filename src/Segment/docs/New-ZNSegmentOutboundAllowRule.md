...
online version: https://github.com/zn.segment/new-znsegmentoutboundallowrule
schema: 2.0.0
---

# New-ZNSegmentOutboundAllowRule
...
```
New-ZNSegmentOutboundAllowRule -ExpiresAt <Int32> -LocalEntityId <String> -LocalProcessesList <String[]>
