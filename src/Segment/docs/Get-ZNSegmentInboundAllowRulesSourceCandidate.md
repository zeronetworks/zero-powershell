...
online version: https://github.com/zn.segment/get-znsegmentinboundallowrulessourcecandidate
schema: 2.0.0
---

# Get-ZNSegmentInboundAllowRulesSourceCandidate
...
```
Get-ZNSegmentInboundAllowRulesSourceCandidate [-Cursor <Int64>] [-Limit <Int32>] [-Search <String>]
 [<CommonParameters>]
```
...
```powershell
(Get-ZNSegmentInboundAllowRulesSourceCandidate).Items
```
...
```powershell
(Get-ZNSegmentInboundAllowRulesSourceCandidate -Search "FS1").Items
```
