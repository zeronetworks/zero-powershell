...
online version: https://github.com/zn.segment/new-znsegmentinboundallowrule
schema: 2.0.0
---
...
```
New-ZNSegmentInboundAllowRule -LocalEntityId <String> -LocalProcessesList <String[]>
...
$source = (Get-ZNSegmentInboundAllowRulesSourceCandidate -search "any asset").Items
$destination = (Get-ZNSegmentInboundAllowRulesDestinationCandidate -Search FS1).Items
New-ZNSegmentInboundAllowRule -LocalEntityId $destination.Id -LocalProcessesList @("*") -PortsList $portsList -RemoteEntityIdsList @($source.id) -State 1
```
