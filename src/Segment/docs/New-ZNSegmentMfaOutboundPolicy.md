...
online version: https://test.comzn.segment/new-znsegmentmfaoutboundpolicy
schema: 2.0.0
---
...
```
New-ZNSegmentMfaOutboundPolicy -DstEntityInfoId <String> -DstPort <String> -DstProcessNames <String[]>
