...
online version: https://github.com/zn.segment/protect-znsegmentassetsot
schema: 2.0.0
---
...
```
Protect-ZNSegmentAssetsOt -Items <String[]> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Protect
```
Protect-ZNSegmentAssetsOt -Body <IAssetBody> [-Confirm] [-WhatIf] [<CommonParameters>]
```
