...
online version: https://github.com/zn.segment/get-znsegmentoutboundallowrulesdestinationcandidate
schema: 2.0.0
---

# Get-ZNSegmentOutboundAllowRulesDestinationCandidate
...
```
Get-ZNSegmentOutboundAllowRulesDestinationCandidate [-Cursor <Int64>] [-Limit <Int32>] [-Search <String>]
 [<CommonParameters>]
```
...
```powershell
(Get-ZNSegmentOutboundAllowRulesDestinationCandidate).Items
```
...
```powershell
(Get-ZNSegmentOutboundAllowRulesDestinationCandidate -search DC1).Items
```
