...
online version: https://github.com/zn.segment/get-znsegmentoutboundallowrulesexcludedsourcecandidate
schema: 2.0.0
---

# Get-ZNSegmentOutboundAllowRulesExcludedSourceCandidate
...
```
Get-ZNSegmentOutboundAllowRulesExcludedSourceCandidate [-Cursor <Int64>] [-Limit <Int32>] [-Search <String>]
 [<CommonParameters>]
```
...
### Example 1: Get possible destinations to exclude for outbound allow rule
```powershell
(Get-ZNSegmentOutboundAllowRulesExcludedSourceCandidate).Items
```
...
```powershell
(Get-ZNSegmentOutboundAllowRulesExcludedSourceCandidate -Search DC1).Items
```
