...
online version: https://github.com/zn.segment/get-znsegmentinboundallowrulesexcludeddestinationcandidate
schema: 2.0.0
---

# Get-ZNSegmentInboundAllowRulesExcludedDestinationCandidate
...
```
Get-ZNSegmentInboundAllowRulesExcludedDestinationCandidate [-Cursor <Int64>] [-Limit <Int32>]
...
```powershell
(Get-ZNSegmentInboundAllowRulesExcludedDestinationCandidate).Items
```
...
```powershell
(Get-ZNSegmentInboundAllowRulesExcludedDestinationCandidate -search DC1).Items
```
