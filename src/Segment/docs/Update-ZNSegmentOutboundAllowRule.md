...
online version: https://github.com/zn.segment/update-znsegmentoutboundallowrule
schema: 2.0.0
---

# Update-ZNSegmentOutboundAllowRule
...
```
Update-ZNSegmentOutboundAllowRule -RuleId <String> -LocalEntityId <String> -LocalProcessesList <String[]>
