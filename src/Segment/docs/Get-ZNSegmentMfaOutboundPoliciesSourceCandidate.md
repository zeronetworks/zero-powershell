...
online version: https://github.com/zn.segment/get-znsegmentmfaoutboundpoliciessourcecandidate
schema: 2.0.0
---

# Get-ZNSegmentMfaOutboundPoliciesSourceCandidate
...
```
Get-ZNSegmentMfaOutboundPoliciesSourceCandidate [-Limit <Int32>] [-Offset <Int32>] [-Search <String>]
 [<CommonParameters>]
```
