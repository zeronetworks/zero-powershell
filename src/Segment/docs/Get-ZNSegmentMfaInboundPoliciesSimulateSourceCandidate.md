...
online version: https://github.com/zn.segment/get-znsegmentmfainboundpoliciessimulatesourcecandidate
schema: 2.0.0
---

# Get-ZNSegmentMfaInboundPoliciesSimulateSourceCandidate
...
```
Get-ZNSegmentMfaInboundPoliciesSimulateSourceCandidate [-Limit <Int32>] [-Offset <Int32>] [-Search <String>]
 [<CommonParameters>]
```
...
```powershell
(Get-ZNSegmentMfaInboundPoliciesSimulateSourceCandidate).Items
```
...
```powershell
(Get-ZNSegmentMfaInboundPoliciesSimulateSourceCandidate -Search DC1).Items
```
