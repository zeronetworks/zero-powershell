...
online version: https://github.com/zn.segment/get-znsegmentassetsmonitored
schema: 2.0.0
---

# Get-ZNSegmentAssetsMonitored
...
```
Get-ZNSegmentAssetsMonitored [-Limit <Int32>] [-Offset <Int32>] [<CommonParameters>]
```
...
```powershell
(Get-ZNSegmentAssetsMonitored).Items
```
...
```powershell
(Get-ZNSegmentAssetsMonitored -Offset 10).Items
```
