...
online version: https://github.com/zn.segment/get-znsegmentinboundallowrulesdestinationcandidate
schema: 2.0.0
---

# Get-ZNSegmentInboundAllowRulesDestinationCandidate
...
```
Get-ZNSegmentInboundAllowRulesDestinationCandidate [-Cursor <Int64>] [-Limit <Int32>] [-Search <String>]
 [<CommonParameters>]
```
...
```powershell
(Get-ZNSegmentInboundAllowRulesDestinationCandidate).Items
```
...
```powershell
(Get-ZNSegmentInboundAllowRulesDestinationCandidate -search DC1).Items
```
