...
online version: https://github.com/zn.segment/get-znsegmentuser
schema: 2.0.0
---
...
```
Get-ZNSegmentUser [-Filters <String>] [-Limit <Int32>] [-Offset <Int32>] [-Search <String>]
 [<CommonParameters>]
```
...
### ZeroNetworks.PowerShell.Cmdlets.Segment.Models.IUser
