...
Get-ZNGroupsAnalysis [-AccountName <String>] -GroupId <String> -GroupType <String> -Direction <String> -DirectlyRetrievedFromAsset -TrafficType <Int32> [-ConnectionState <Int32>] [-From <Int64>] [-Sort <String>] [-To <Int64>] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <Uri>] [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [<CommonParameters>]
...
Update-ZNSwitchInterface [-AccountName <String>] -SwitchId <String> [-Interfaces <String[]>] [-ShouldMonitor] [-SwitchId1 <String>] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru] [-Proxy <Uri>] [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
