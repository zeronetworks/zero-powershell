...
Get-ZNAsset [-AccountName <String>] [-Limit <Int32>] [-Cursor <Int64>] [-Filters <String>] [-Offset <Int32>] [-Order <String>] [-OrderColumns <String>] [-ShowInactive] [-ShowOnlyIPSecConfiguredAssets] [-WithCount] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <Uri>] [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [<CommonParameters>]
...
Get-ZNK8SNamespaceWorkloadLabel [-AccountName <String>] -K8SNamespaceId <String> -K8SWorkloadId <String> [-Limit <Int32>] [-Filters <String>] [-Offset <Int32>] [-Order <String>] [-OrderColumns <String>] [-WithCount] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <Uri>] [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [<CommonParameters>]




Get-ZNK8SNode [-AccountName <String>] [-Limit <Int32>] [-Filters <String>] [-Offset <Int32>] [-Order <String>] [-OrderColumns <String>] [-WithCount] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <Uri>] [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [<CommonParameters>]
...
Get-ZNSettingsMaintenanceWindow [-AccountName <String>] -InputObject <IApiIdentity> [-Break] [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <Uri>] [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [<CommonParameters>]
...
New-ZNSettingsAd [-AccountName <String>] [-AllowNtlmFallback] [-PrimaryDomainConfigDeploymentsClusterId <String>] [-PrimaryDomainConfigDomainControllerFqdn <String>] [-PrimaryDomainConfigDomainName <String>] [-PrimaryDomainConfigPassword <String>] [-PrimaryDomainConfigUseLdaps] [-PrimaryDomainConfigUserFqdn <String>] [-UsePrimaryUserForAllDomains] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <Uri>] [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
...
Update-ZNAssetsDeploymentsCluster [-AccountName <String>] -AssetIds <String[]> [-DeploymentsClusterId <String>] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <Uri>] [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
