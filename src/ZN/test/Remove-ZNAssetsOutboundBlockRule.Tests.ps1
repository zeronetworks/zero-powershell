...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'Remove-ZNAssetsOutboundBlockRule.Recording.json'
...
Describe 'Remove-ZNAssetsOutboundBlockRule' {
    It 'Delete' {
        ...
        { Remove-ZNAssetsOutboundBlockRule -AssetId $asset -RuleId $rule.ItemId } | Should -Not -Throw
    }
}
