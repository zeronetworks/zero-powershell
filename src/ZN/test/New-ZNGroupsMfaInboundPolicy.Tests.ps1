if(($null -eq $TestName) -or ($TestName -contains 'New-ZNGroupsMfaInboundPolicy'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-ZNGroupsMfaInboundPolicy.Recording.json'
...
Describe 'New-ZNGroupsMfaInboundPolicy' {
    It 'CreateExpanded' {
