...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'Remove-ZNAssetsMfaOutboundPolicy.Recording.json'
...
Describe 'Remove-ZNAssetsMfaOutboundPolicy' {
    It 'Delete' {
        ...
        { Remove-ZNAssetsMfaOutboundPolicy -AssetId $asset.id -ReactivePolicyId $policy.ItemId } | Should -Not -Throw
    }
}
