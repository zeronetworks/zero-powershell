if(($null -eq $TestName) -or ($TestName -contains 'New-ZNAssetMfaIdentityPolicy'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-ZNAssetMfaIdentityPolicy.Recording.json'
...
Describe 'New-ZNAssetMfaIdentityPolicy' {
    It 'CreateExpanded' {
