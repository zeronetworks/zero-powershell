...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'Update-ZNAssetsOutboundBlockRule.Recording.json'
...
Describe 'Update-ZNAssetsOutboundBlockRule' {
    It 'UpdateExpanded' {
        ...
        Update-ZNAssetsOutboundBlockRule -Asset $asset -RuleId $rule.ItemId -Description $newdescription
        $updatedRule = Get-ZNAssetsOutboundBlockRule -Asset $asset -RuleId $rule.ItemId
