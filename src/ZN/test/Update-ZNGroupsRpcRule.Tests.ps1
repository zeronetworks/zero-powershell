if(($null -eq $TestName) -or ($TestName -contains 'Update-ZNGroupsRpcRule'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Update-ZNGroupsRpcRule.Recording.json'
...
Describe 'Update-ZNGroupsRpcRule' {
    It 'UpdateExpanded' {
