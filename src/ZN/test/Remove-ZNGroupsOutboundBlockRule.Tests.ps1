...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'Remove-ZNGroupsOutboundBlockRule.Recording.json'
...
Describe 'Remove-ZNGroupsOutboundBlockRule' {
    It 'Delete' {
        ...
        { Remove-ZNGroupsOutboundBlockRule -GroupId $group.id -GroupType tag -RuleId $rule.Item.Id} | Should -Not -Throw
    }
}
