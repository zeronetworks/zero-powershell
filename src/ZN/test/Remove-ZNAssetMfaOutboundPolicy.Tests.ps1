...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'Remove-ZNAssetMfaOutboundPolicy.Recording.json'
...
Describe 'Remove-ZNAssetMfaOutboundPolicy' {
    It 'Delete' {
        ...
        { Remove-ZNAssetMfaOutboundPolicy -AssetId $asset -ReactivePolicyId $policy.ItemId } | Should -Not -Throw
    }
}
