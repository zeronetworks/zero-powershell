if(($null -eq $TestName) -or ($TestName -contains 'Remove-ZNGroupsOutboundRule'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Remove-ZNGroupsOutboundRule.Recording.json'
...
Describe 'Remove-ZNGroupsOutboundRule' {
    It 'Delete' {
