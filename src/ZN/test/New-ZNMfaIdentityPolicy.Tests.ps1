if(($null -eq $TestName) -or ($TestName -contains 'New-ZNMfaIdentityPolicy'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-ZNMfaIdentityPolicy.Recording.json'
...
Describe 'New-ZNMfaIdentityPolicy' {
    It 'CreateExpanded' {
