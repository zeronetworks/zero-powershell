...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'Update-ZNAssetsMfaOutboundPolicy.Recording.json'
...
Describe 'Update-ZNAssetsMfaOutboundPolicy' {
    It 'UpdateExpanded' {
        ...
        Update-ZNAssetsMfaOutboundPolicy -AssetId $asset.id -ReactivePolicyId $policy.ItemId -Description $newdescription
