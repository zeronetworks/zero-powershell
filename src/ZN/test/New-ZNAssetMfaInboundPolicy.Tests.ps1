if(($null -eq $TestName) -or ($TestName -contains 'New-ZNAssetMfaInboundPolicy'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-ZNAssetMfaInboundPolicy.Recording.json'
