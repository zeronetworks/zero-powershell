...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'Remove-ZNGroupsInboundBlockRule.Recording.json'
...
Describe 'Remove-ZNGroupsInboundBlockRule' {
    It 'Delete' {
        ...
        { Remove-ZNGroupsInboundBlockRule -GroupId $group.Id -GroupType tag -RuleId $rule.ItemId } | Should -Not -Throw
    }
}
