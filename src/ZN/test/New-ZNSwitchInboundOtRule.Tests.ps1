if(($null -eq $TestName) -or ($TestName -contains 'New-ZNSwitchInboundOtRule'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-ZNSwitchInboundOtRule.Recording.json'
...
Describe 'New-ZNSwitchInboundOtRule' {
    It 'CreateExpanded' {
