if(($null -eq $TestName) -or ($TestName -contains 'Get-ZNSettingsAdLinuxMonitoredCandidate'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Get-ZNSettingsAdLinuxMonitoredCandidate.Recording.json'
