...
. ($loadEnvPath)
$TestRecordingFile = Join-Path $PSScriptRoot 'Remove-ZNGroupsInboundAllowRule.Recording.json'
...
Describe 'Remove-ZNGroupsInboundAllowRule' {
    It 'Delete' {
        ...
        { Remove-ZNGroupsInboundAllowRule -GroupId $group.Id -GroupType tag -RuleId $rule.Item.Id } | Should -Not -Throw
    }
}
