if(($null -eq $TestName) -or ($TestName -contains 'Remove-ZNGroupsInboundOtRule'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Remove-ZNGroupsInboundOtRule.Recording.json'
