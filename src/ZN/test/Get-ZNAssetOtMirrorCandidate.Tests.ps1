if(($null -eq $TestName) -or ($TestName -contains 'Get-ZNAssetOtMirrorCandidate'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Get-ZNAssetOtMirrorCandidate.Recording.json'
