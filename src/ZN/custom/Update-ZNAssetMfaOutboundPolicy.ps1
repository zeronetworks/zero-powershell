...
.Link
https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/update-znassetmfaoutboundpolicy
#>
function Update-ZNAssetMfaOutboundPolicy {
    ...
    process {
        try {
            ...
            $policy = ZeroNetworks\Get-ZNAssetMfaOutboundPolicy -AssetId $assetId -ReactivePolicyId $policyId
