...
.Link
https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/update-zngroupsmfainboundpolicy
#>
function Update-ZNGroupsMfaInboundPolicy {
    ...
    process {
        try {
            ...
            $policy = ZeroNetworks\Get-ZNGroupsMfaInboundPolicy -GroupId $groupId -GroupType $groupType -ReactivePolicyId $policyId
            ...
            ZeroNetworks.internal\Update-ZNGroupsMfaInboundPolicy @PSBoundParameters
        }
        catch {
            throw
        }
