...
.Link
https://github.com/zeronetworks/zero-powershell/Deny-ZNAssetsInboundAllowRuleReview
#>
function Deny-ZNAssetsInboundAllowRuleReview {
    ...
    process {
        try {
            ...
            ZeroNetworks.internal\Deny-ZNAssetsInboundAllowRulesReview @PSBoundParameters
        }
        catch {
            throw
        }
