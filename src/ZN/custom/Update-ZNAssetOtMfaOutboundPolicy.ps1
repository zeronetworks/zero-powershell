...
.Link
https://github.com/zeronetworks/zero-powershell/update-znassetotmfaoutboundpolicy
#>
function Update-ZNAssetOtMfaOutboundPolicy {
    ...
    process {
        try {
            ...
            $policy = ZeroNetworks\Get-ZNAssetOtMfaOutboundPolicy -AssetId $assetId -ReactivePolicyId $policyId
            ...
            ZeroNetworks.internal\Update-ZNAssetOtMfaOutboundPolicy @PSBoundParameters
        }
        catch {
            throw
        }
