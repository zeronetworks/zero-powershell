...
.Link
https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znusermfaoutboundpolicy
#>
function Update-ZNUserMfaOutboundPolicy {
    ...
    process {
        try {
            ...
            ZeroNetworks.internal\Update-ZNUserMfaOutboundPolicy @PSBoundParameters
        }
        catch {
            throw
        }
