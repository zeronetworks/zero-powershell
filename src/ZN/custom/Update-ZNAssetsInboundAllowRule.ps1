...
.Link
https://github.com/zeronetworks/zero-powershell/update-znassetsinboundallowrule
#>
function Update-ZNAssetsInboundAllowRule {
    ...
    process {
        try {
            ...
            $rule = ZeroNetworks\Get-ZNAssetsInboundAllowRule -AssetId $assetId -RuleId $ruleId
            ...
            ZeroNetworks.internal\Update-ZNAssetsInboundAllowRule @PSBoundParameters
        }
        catch {
            throw
        }
