...
.Link
https://github.com/zeronetworks/zero-powershell/zeronetworks/update-zngroupsmfaidentitypolicy
#>
function Update-ZNGroupsMfaIdentityPolicy {
    ...
    process {
        try {
            ...
            $policy = ZeroNetworks\Get-ZNGroupsMfaIdentityPolicy -GroupId $groupId -GroupType $groupType -ReactivePolicyId $policyId
            ...
            ZeroNetworks.internal\Update-ZNGroupsMfaIdentityPolicy @PSBoundParameters
        }
        catch {
            throw
        }
