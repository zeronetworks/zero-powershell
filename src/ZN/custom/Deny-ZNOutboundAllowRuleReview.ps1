...
.Link
https://github.com/zeronetworks/zero-powershell/Deny-ZNOutboundAllowRuleReview
#>
function Deny-ZNOutboundAllowRuleReview {
    ...
    process {
        try {
            ...
            ZeroNetworks.internal\Deny-ZNOutboundAllowRulesReview @PSBoundParameters
        }
        catch {
            throw
        }
