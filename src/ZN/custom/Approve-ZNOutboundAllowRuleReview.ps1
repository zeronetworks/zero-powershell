...
.Link
https://github.com/zeronetworks/zero-powershell/Approve-ZNOutboundAllowRuleReview
#>
function Approve-ZNOutboundAllowRuleReview {
    ...
    process {
        try {
            ...
            switch ($PsCmdlet.ParameterSetName) {
                "ApproveExpanded" {
                    ZeroNetworks.internal\Approve-ZNOutboundAllowRulesReview @PSBoundParameters
                }
                "ApproveWithChangesExpanded" {
                    ...
                    ZeroNetworks.internal\Approve-ZNOutboundAllowRuleReview @PSBoundParameters
                }
            }
        }
        catch {
