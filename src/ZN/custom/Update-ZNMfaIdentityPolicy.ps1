...
.Link
https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/update-znmfaidentitypolicy
#>
function Update-ZNMfaIdentityPolicy {
    ...
    process {
        try {
            ...
            $policy = ZeroNetworks\Get-ZNMfaIdentityPolicy -ReactivePolicyId $policyId
            ...
            ZeroNetworks.internal\Update-ZNMfaIdentityPolicy @PSBoundParameters
        }
        catch {
            throw
        }
