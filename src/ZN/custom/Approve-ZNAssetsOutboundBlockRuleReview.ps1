...
.Link
https://github.com/zeronetworks/zero-powershell/Approve-ZNAssetsOutboundBlockRuleReview
#>
function Approve-ZNAssetsOutboundBlockRuleReview {
    ...
    process {
        try {
            ...
            switch ($PsCmdlet.ParameterSetName) {
                "ApproveExpanded" {
                    ZeroNetworks.internal\Approve-ZNAssetsOutboundBlockRulesReview @PSBoundParameters
                }
                "ApproveWithChangesExpanded" {
                    ...
                    ZeroNetworks.internal\Approve-ZNAssetOutboundBlockRuleReview @PSBoundParameters
                }
            }
        }
        catch {
