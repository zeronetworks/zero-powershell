...
.Link
https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/update-znmassetfaidentitypolicy
#>
function Update-ZNAssetMfaIdentityPolicy {
    ...
    process {
        try {
            ...
            $policy = ZeroNetworks\Get-ZNAssetMfaIdentityPolicy -AssetId $assetId -ReactivePolicyId $policyId
            ...
            ZeroNetworks.internal\Update-ZNAssetMfaIdentityPolicy @PSBoundParameters
        }
        catch {
            throw
        }
