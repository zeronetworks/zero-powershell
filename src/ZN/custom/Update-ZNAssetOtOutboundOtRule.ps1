...
.Link
https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znassetotoutboundotrule
#>
function Update-ZNAssetOtOutboundOtrule {
    ...
    process {
        try {
            ...
            ZeroNetworks.internal\Update-ZNAssetOtOutboundOtrule @PSBoundParameters
        }
        catch {
            throw
        }
