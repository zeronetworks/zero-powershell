...
.Link
https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/update-znuseridentityrule
#>
function Update-ZNUserIdentityRule {
    ...
    process {
        try {
            ...
            $rule = ZeroNetworks\Get-ZNUserIdentityRule -UserId $userId -RuleId $ruleId
