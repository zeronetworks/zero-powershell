...
.Link
https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znswitchinboundotrule
#>
function Update-ZNSwitchInboundOtrule {
    ...
    process {
        try {
            ...
            ZeroNetworks.internal\Update-ZNSwitchInboundOtrule @PSBoundParameters
        }
        catch {
            throw
        }
