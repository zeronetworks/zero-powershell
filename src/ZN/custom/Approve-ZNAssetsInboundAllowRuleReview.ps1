...
.Link
https://github.com/zeronetworks/zero-powershell/Approve-ZNAssetsInboundAllowRuleReview
#>
function Approve-ZNAssetsInboundAllowRuleReview {
    ...
    process {
        try {
            ...
            switch ($PsCmdlet.ParameterSetName) {
                "ApproveExpanded" {
                    ZeroNetworks.internal\Approve-ZNAssetsInboundAllowRulesReview @PSBoundParameters
                }
                "ApproveWithChangesExpanded" {
                    ...
                    ZeroNetworks.internal\Approve-ZNAssetInboundAllowRuleReview @PSBoundParameters
                }
            }
        }
        catch {
