...
.Link
https://github.com/zeronetworks/zero-powershell/Deny-ZNAssetsInboundBlockRuleReview
#>
function Deny-ZNAssetsInboundBlockRuleReview {
    ...
    process {
        try {
            ...
            ZeroNetworks.internal\Deny-ZNAssetsInboundBlockRulesReview @PSBoundParameters
        }
        catch {
            throw
        }
