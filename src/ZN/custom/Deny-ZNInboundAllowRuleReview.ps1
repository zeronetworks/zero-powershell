...
.Link
https://github.com/zeronetworks/zero-powershell/Deny-ZNInboundAllowRuleReview
#>
function Deny-ZNInboundAllowRuleReview {
    ...
    process {
        try {
            ...
            ZeroNetworks.internal\Deny-ZNInboundAllowRulesReview @PSBoundParameters
        }
        catch {
            throw
        }
