...
.Link
https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/update-zngroupsmfaoutboundpolicy
#>
function Update-ZNGroupsMfaOutboundPolicy {
    ...
    process {
        try {
            ...
            $policy = ZeroNetworks\Get-ZNGroupsMfaOutboundPolicy -GroupId $groupId -GroupType $groupType -ReactivePolicyId $policyId
            ...
            ZeroNetworks.internal\Update-ZNGroupsMfaOutboundPolicy @PSBoundParameters
        }
        catch {
            throw
        }
