...
.Link
https://github.com/zeronetworks/zero-powershell/update-zngroupsoutboundallowrule
#>
function Update-ZNGroupsOutboundAllowRule {
    ...
    process {
        try {
            ...
            $rule = ZeroNetworks\Get-ZNGroupsOutboundAllowRule -GroupId $groupId -GroupType $groupType -RuleId $ruleId
            ...
            ZeroNetworks.internal\Update-ZNGroupsOutboundAllowRule @PSBoundParameters
        }
        catch {
            throw
        }
