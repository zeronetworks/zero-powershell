...
.Link
https://github.com/zeronetworks/zero-powershell/update-znGroupsinboundallowrule
#>
function Update-ZNGroupsInboundAllowRule {
    ...
    process {
        try {
            ...
            $rule = ZeroNetworks\Get-ZNGroupsInboundAllowRule -GroupId $groupId -GroupType $groupType -RuleId $ruleId
            ...
            ZeroNetworks.internal\Update-ZNGroupsInboundAllowRule @PSBoundParameters
        }
        catch {
            throw
        }
