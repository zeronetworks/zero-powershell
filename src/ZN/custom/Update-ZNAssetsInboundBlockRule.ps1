...
.Link
https://github.com/zeronetworks/zero-powershell/update-znassetsinboundblockrule
#>
function Update-ZNAssetsInboundBlockRule {
    ...
    process {
        try {
            ...
            $rule = ZeroNetworks\Get-ZNAssetsInboundBlockRule -AssetId $assetId -RuleId $ruleId
            ...
            ZeroNetworks.internal\Update-ZNAssetsInboundBlockRule @PSBoundParameters
        }
        catch {
            throw
        }
