...
.Link
https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/update-zngroupsrpcrule
#>
function Update-ZNGroupsRpcRule {
    ...
    process {
        try {
            ...
            $rule = ZeroNetworks\Get-ZNGroupsRpcRule -GroupId $groupId -GroupType $groupType -RuleId $ruleId
            ...
            ZeroNetworks.internal\Update-ZNGroupsRpcRule @PSBoundParameters
        }
        catch {
            throw
        }
