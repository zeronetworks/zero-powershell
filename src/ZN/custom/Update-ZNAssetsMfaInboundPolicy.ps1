...
.Link
https://github.com/zeronetworks/zero-powershell/update-znassetsmfainboundpolicy
#>
function Update-ZNAssetsMfaInboundPolicy {
    ...
    process {
        try {
            ...
            $policy = ZeroNetworks\Get-ZNAssetsMfaInboundPolicy -AssetId $assetId -ReactivePolicyId $policyId
            ...
            ZeroNetworks.internal\Update-ZNAssetsMfaInboundPolicy @PSBoundParameters
        }
        catch {
            throw
        }
