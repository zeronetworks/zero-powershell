...
.Link
https://github.com/zeronetworks/zero-powershell/Approve-ZNInboundBlockRuleReview
#>
function Approve-ZNInboundBlockRuleReview {
    ...
    process {
        try {
            ...
            switch ($PsCmdlet.ParameterSetName) {
                "ApproveExpanded" {
                    ZeroNetworks.internal\Approve-ZNInboundBlockRulesReview @PSBoundParameters
                }
                "ApproveWithChangesExpanded" {
                    ...
                    ZeroNetworks.internal\Approve-ZNInboundBlockRuleReview @PSBoundParameters
                }
            }
        }
        catch {
