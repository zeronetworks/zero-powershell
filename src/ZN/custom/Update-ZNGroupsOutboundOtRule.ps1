...
.Link
https://github.com/zeronetworks/zero-powershell/zeronetworks/update-zngroupsoutboundotrule
#>
function Update-ZNGroupsOutboundOtRule {
    ...
    process {
        try {
            ...
            $rule = ZeroNetworks\Get-ZNGroupsOutboundOtRule -GroupId $groupId -GroupType $groupType -RuleId $ruleId
