...
.Link
https://github.com/zeronetworks/zero-powershell/Deny-ZNOutboundBlockRuleReview
#>
function Deny-ZNOutboundBlockRuleReview {
    ...
    process {
        try {
            ...
            ZeroNetworks.internal\Deny-ZNOutboundBlockRulesReview @PSBoundParameters
        }
        catch {
            throw
        }
