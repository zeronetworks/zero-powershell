...
.Link
https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/Approve-ZNAssetOutboundRuleReview
#>
    ...
    process {
        try {
            ...
            switch ($PsCmdlet.ParameterSetName) {
                "ApproveExpanded" {
                    ZeroNetworks.internal\Approve-ZNAssetOutboundRulesReview @PSBoundParameters
                }
