...
.Link
https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/update-znassetoutboundrule
#>
function Update-ZNAssetOutboundRule {
    ...
    process {
        try {
            ...
            ZeroNetworks.internal\Update-ZNAssetOutboundRule @PSBoundParameters
        }
        catch {
            throw
        }
