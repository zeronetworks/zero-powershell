...
.Link
https://github.com/zeronetworks/zero-powershell/update-znassetsmfaoutboundpolicy
#>
function Update-ZNAssetsMfaOutboundPolicy {
    ...
    process {
        try {
            ...
            $policy = ZeroNetworks\Get-ZNAssetsMfaOutboundPolicy -AssetId $assetId -ReactivePolicyId $policyId
            ...
            ZeroNetworks.internal\Update-ZNAssetsMfaOutboundPolicy @PSBoundParameters
        }
        catch {
            throw
        }
