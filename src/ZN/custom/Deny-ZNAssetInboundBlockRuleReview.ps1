...
.Link
https://github.com/zeronetworks/zero-powershell/Deny-ZNAssetInboundBlockRuleReview
#>
function Deny-ZNAssetInboundBlockRuleReview {
    ...
    process {
        try {
            ...
            ZeroNetworks.internal\Deny-ZNAssetInboundBlockRulesReview @PSBoundParameters
        }
        catch {
            throw
        }
