...
.Link
https://github.com/zeronetworks/zero-powershell/zeronetworks/update-zninboundotrule
#>
function Update-ZNInboundOtrule {
    ...
    process {
        try {
            ...
            ZeroNetworks.internal\Update-ZNInboundOtrule @PSBoundParameters
        }
        catch {
            throw
        }
