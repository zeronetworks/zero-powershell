...
.Link
https://github.com/zeronetworks/zero-powershell/Approve-ZNAssetOutboundBlockRuleReview
#>
function Approve-ZNAssetOutboundBlockRuleReview {
    ...
    process {
        try {
            ...
            switch ($PsCmdlet.ParameterSetName) {
                "ApproveExpanded" {
                    ZeroNetworks.internal\Approve-ZNAssetOutboundBlockRulesReview @PSBoundParameters
                }
