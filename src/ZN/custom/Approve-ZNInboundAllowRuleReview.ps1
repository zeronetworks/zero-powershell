...
.Link
https://github.com/zeronetworks/zero-powershell/Approve-ZNInboundAllowRuleReview
#>
function Approve-ZNInboundAllowRuleReview {
    ...
    process {
        try {
            ...
            switch ($PsCmdlet.ParameterSetName) {
                "ApproveExpanded" {
                    ZeroNetworks.internal\Approve-ZNInboundAllowRulesReview @PSBoundParameters
                }
                "ApproveWithChangesExpanded" {
                    ...
                    ZeroNetworks.internal\Approve-ZNInboundAllowRuleReview @PSBoundParameters
                }
            }
        }
        catch {
