...
.Link
https://github.com/zeronetworks/zero-powershell/Approve-ZNAssetsInboundBlockRuleReview
#>
function Approve-ZNAssetsInboundBlockRuleReview {
    ...
    process {
        try {
            ...
            switch ($PsCmdlet.ParameterSetName) {
                "ApproveExpanded" {
                    ZeroNetworks.internal\Approve-ZNAssetsInboundBlockRulesReview @PSBoundParameters
                }
                "ApproveWithChangesExpanded" {
                    #Handle Get
                    $ruleId = $PSBoundParameters['RuleId'].ToString()
                    $rule = ZeroNetworks\Get-ZNInboundBlockRule -RuleId $ruleId
                    ...
                    ZeroNetworks.internal\Approve-ZNAssetInboundBlockRuleReview @PSBoundParameters
                }
            }
        }
        catch {
