...
.Link
https://github.com/zeronetworks/zero-powershell/update-znassetsoutboundallowrule
#>
function Update-ZNAssetsOutboundAllowRule {
    ...
    process {
        try {
            ...
            $rule = ZeroNetworks\Get-ZNAssetsOutboundAllowRule -AssetId $assetId -RuleId $ruleId
            ...
            ZeroNetworks.internal\Update-ZNAssetsOutboundAllowRule @PSBoundParameters
        }
        catch {
            throw
        }
