...
function Update-ZNAssetMfaInboundPolicy {
    ...
    process {
        try {
            ...
            $policy = ZeroNetworks\Get-ZNAssetMfaInboundPolicy -AssetId $assetId -ReactivePolicyId $policyId
            ...
            ZeroNetworks.internal\Update-ZNAssetMfaInboundPolicy @PSBoundParameters
        }
        catch {
            throw
        }
