...
.Link
https://github.com/zeronetworks/zero-powershell/zeronetworks/tree/master/src/help/zeronetworks/update-zninternalaccesspolicy
#>
function Update-ZNInternalAccessPolicy {
    [OutputType([ZeroNetworks.PowerShell.Cmdlets.Api.Models.InternalAccessPolicyItem])]
    ...
    process {
        try {
            ...
            $policy = ZeroNetworks\Get-ZNInternalAccessPolicy -PolicyId $policyId

            $updatedPolicy = [ZeroNetworks.PowerShell.Cmdlets.Api.Models.InternalAccessPolicyBody]::new()
            ...
            ZeroNetworks.internal\Update-ZNInternalAccessPolicy @PSBoundParameters
        }
        catch {
            throw
        }
