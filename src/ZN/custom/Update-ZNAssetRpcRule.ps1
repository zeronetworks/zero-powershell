...
.Link
https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/update-znassetrpcrule
#>
function Update-ZNAssetRpcRule {
    ...
    process {
        try {
            ...
            $rule = ZeroNetworks\Get-ZNAssetRpcRule -AssetId $assetId -RuleId $ruleId
            ...
            ZeroNetworks.internal\Update-ZNAssetRpcRule @PSBoundParameters
        }
        catch {
            throw
        }
