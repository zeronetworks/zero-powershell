...
.Link
https://github.com/zeronetworks/zero-powershell/update-znassetoutboundallowrule
#>
function Update-ZNAssetOutboundAllowRule {
    ...
    process {
        try {
            ...
            $rule = ZeroNetworks\Get-ZNAssetOutboundAllowRule -AssetId $assetId -RuleId $ruleId
            $rule = $rule.Item
            ...
            ZeroNetworks.internal\Update-ZNAssetOutboundAllowRule @PSBoundParameters
        }
        catch {
            throw
        }
