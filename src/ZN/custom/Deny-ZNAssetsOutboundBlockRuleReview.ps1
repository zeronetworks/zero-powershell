...
.Link
https://github.com/zeronetworks/zero-powershell/Deny-ZNAssetsOutboundBlockRuleReview
#>
function Deny-ZNAssetsOutboundBlockRuleReview {
    ...
    process {
        try {
            ...
            ZeroNetworks.internal\Deny-ZNAssetsOutboundBlockRulesReview @PSBoundParameters
        }
        catch {
            throw
        }
