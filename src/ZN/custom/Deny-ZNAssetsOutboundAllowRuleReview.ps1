...
.Link
https://github.com/zeronetworks/zero-powershell/Deny-ZNAssetsOutboundAllowRuleReview
#>
function Deny-ZNAssetsOutboundAllowRuleReview {
    ...
    process {
        try {
            ...
            ZeroNetworks.internal\Deny-ZNAssetsOutboundAllowRulesReview @PSBoundParameters
        }
        catch {
            throw
        }
