...
.Link
https://github.com/zeronetworks/zero-powershell/Deny-ZNAssetOutboundAllowRuleReview
#>
function Deny-ZNAssetOutboundAllowRuleReview {
    ...
    process {
        try {
            ...
            ZeroNetworks.internal\Deny-ZNAssetOutboundAllowRulesReview @PSBoundParameters
        }
        catch {
            throw
        }
