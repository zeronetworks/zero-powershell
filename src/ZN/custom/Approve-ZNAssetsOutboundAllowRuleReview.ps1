...
.Link
https://github.com/zeronetworks/zero-powershell/Approve-ZNAssetsOutboundAllowRuleReview
#>
function Approve-ZNAssetsOutboundAllowRuleReview {
    ...
    process {
        try {
            ...
            switch ($PsCmdlet.ParameterSetName) {
                "ApproveExpanded" {
                    ZeroNetworks.internal\Approve-ZNAssetsOutboundAllowRulesReview @PSBoundParameters
                }
                "ApproveWithChangesExpanded" {
                    #Handle Get
                    $ruleId = $PSBoundParameters['RuleId'].ToString()
                    $rule = ZeroNetworks\Get-ZNOutboundAllowRule -RuleId $ruleId
                    ...
                    ZeroNetworks.internal\Approve-ZNAssetOutboundAllowRuleReview @PSBoundParameters
                }
            }
        }
        catch {
