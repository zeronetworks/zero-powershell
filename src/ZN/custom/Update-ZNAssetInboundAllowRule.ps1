...
.Link
https://github.com/zeronetworks/zero-powershell/update-znassetinboundallowrule
#>
function Update-ZNAssetInboundAllowRule {
    ...
    process {
        try {
            ...
            $rule = ZeroNetworks\Get-ZNAssetInboundAllowRule -AssetId $assetId -RuleId $ruleId
            ...
            ZeroNetworks.internal\Update-ZNAssetInboundAllowRule @PSBoundParameters
        }
        catch {
            throw
        }
