...
.Link
https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/update-znoutboundrule
#>
function Update-ZNOutboundRule {
    ...
    process {
        try {
            ...
            ZeroNetworks.internal\Update-ZNOutboundRule @PSBoundParameters
        }
        catch {
            throw
        }
