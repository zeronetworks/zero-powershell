...
.Link
https://github.com/zeronetworks/zero-powershell/Deny-ZNAssetInboundAllowRuleReview
#>
function Deny-ZNAssetInboundAllowRuleReview {
    ...
    process {
        try {
            ...
            ZeroNetworks.internal\Deny-ZNAssetInboundAllowRulesReview @PSBoundParameters
        }
        catch {
            throw
        }
