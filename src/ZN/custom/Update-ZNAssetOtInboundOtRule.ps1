...
.Link
https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znassetotinboundotrule
#>
function Update-ZNAssetOtInboundOtrule {
    ...
    process {
        try {
            ...
            $rule = ZeroNetworks\Get-ZNInboundOtRule -RuleId $ruleId
            ...
            ZeroNetworks.internal\Update-ZNAssetOtInboundOtrule @PSBoundParameters
        }
        catch {
            throw
        }
