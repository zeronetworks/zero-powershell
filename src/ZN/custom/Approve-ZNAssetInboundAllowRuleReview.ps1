...
.Link
https://github.com/zeronetworks/zero-powershell/Approve-ZNAssetInboundAllowRuleReview
#>
function Approve-ZNAssetInboundAllowRuleReview {
    ...
    process {
        try {
            ...
            switch ($PsCmdlet.ParameterSetName) {
                "ApproveExpanded" {
                    ZeroNetworks.internal\Approve-ZNAssetInboundAllowRulesReview @PSBoundParameters
                }
