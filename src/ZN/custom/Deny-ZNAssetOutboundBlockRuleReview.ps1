...
.Link
https://github.com/zeronetworks/zero-powershell/Deny-ZNAssetOutboundBlockRuleReview
#>
function Deny-ZNAssetOutboundBlockRuleReview {
    ...
    process {
        try {
            ...
            ZeroNetworks.internal\Deny-ZNAssetOutboundBlockRulesReview @PSBoundParameters
        }
        catch {
            throw
        }
