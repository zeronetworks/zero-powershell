...
.Link
https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/update-znGroupsinboundrule
#>
function Update-ZNGroupsInboundRule {
    ...
    process {
        try {
            ...
            $rule = ZeroNetworks\Get-ZNGroupsInboundRule -GroupId $groupId -GroupType $groupType -RuleId $ruleId
            #$rule = $rule.ItemItem
            ...
            ZeroNetworks.internal\Update-ZNGroupsInboundRule @PSBoundParameters
        }
        catch {
            throw
        }
