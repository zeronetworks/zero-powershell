...
.Link
https://github.com/zeronetworks/zero-powershell/Approve-ZNAssetOutboundAllowRuleReview
#>
function Approve-ZNAssetOutboundAllowRuleReview {
    ...
    process {
        try {
            ...
            switch ($PsCmdlet.ParameterSetName) {
                "ApproveExpanded" {
                    ZeroNetworks.internal\Approve-ZNAssetOutboundAllowRulesReview @PSBoundParameters
                }
