...
.Link
https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znassetinboundotrule
#>
function Update-ZNAssetInboundOtrule {
    ...
    process {
        try {
            ...
            ZeroNetworks.internal\Update-ZNAssetInboundOtrule @PSBoundParameters
        }
        catch {
            throw
        }
