...
.Link
https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znaeexclusionsoutbound 
#>
function Update-ZNAeExclusionsOutbound {
    ...
    process {
        try {
            ...
            $aeExclusion = ZeroNetworks\Get-ZNAeExclusionsOutbound -RuleId $aeExclusionId
            ...
            if($PSBoundParameters['SrcUsersList']){
                $updatedAeExclusion.SrcUsersList = $PSBoundParameters['SrcUsersList']
                $null = $PSBoundParameters.Remove('SrcUsersList')
            }
            else{
                $updatedAeExclusion.SrcUsersList = $aeExclusion.ItemSrcUsersList
                $null = $PSBoundParameters.Remove('SrcUsersList')
            }
            ...
            ZeroNetworks.internal\Update-ZNAeExclusionsOutbound @PSBoundParameters
        }
        catch {
            throw
        }
