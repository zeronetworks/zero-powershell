...
online version: https://github.com/zeronetworkszeronetworks/get-znoutboundblockrulessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNOutboundBlockRulesSourceCandidate [-Cursor <Int64>] [-Limit <Int32>] [-Search <String>]
 [<CommonParameters>]
```
