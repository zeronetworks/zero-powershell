...
online version: https://github.com/zeronetworkszeronetworks/get-znassetsinboundblockrulessourcecandidate
schema: 2.0.0
---

# Get-ZNAssetsInboundBlockRulesSourceCandidate
...
```
Get-ZNAssetsInboundBlockRulesSourceCandidate -AssetId <String> [-Cursor <Int64>] [-Limit <Int32>]
