...
online version: https://github.com/zeronetworkszeronetworks/get-zngroupsoutboundrulessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNGroupsOutboundRulesSourceCandidate -GroupId <String> -GroupType <String> [-Cursor <String>]
...
(Get-ZNGroupsOutboundRulesSourceCandidate -Groupid $group.id -GroupType tag).Items        
```
