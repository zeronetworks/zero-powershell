...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znsettingssegmentserversfreezeperiod
schema: 2.0.0
---

# Update-ZNSettingsSegmentServersFreezePeriod
...
```
Update-ZNSettingsSegmentServersFreezePeriod -FreezePeriodId <String> [-AccountName <String>]
