...
online version: https://github.com/zeronetworkszeronetworks/remove-znassetotrpcrule
schema: 2.0.0
---
...
```
Remove-ZNAssetOtrpcRule -AssetId <String> -RuleId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
