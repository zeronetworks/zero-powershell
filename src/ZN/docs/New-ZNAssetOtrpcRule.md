...
online version: https://github.com/zeronetworkszeronetworks/new-znassetotrpcrule
schema: 2.0.0
---
...
```
New-ZNAssetOtrpcRule -AssetId <String> -Action <Int32> -Description <String> -ExcludedAssetIdsList <String[]>
