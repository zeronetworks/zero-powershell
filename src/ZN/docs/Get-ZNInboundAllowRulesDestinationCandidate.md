...
online version: https://github.com/zeronetworkszeronetworks/get-zninboundallowrulesdestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNInboundAllowRulesDestinationCandidate [-Cursor <Int64>] [-Limit <Int32>] [-Search <String>]
 [<CommonParameters>]
```
