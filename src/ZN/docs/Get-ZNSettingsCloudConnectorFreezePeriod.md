...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znsettingscloudconnectorfreezeperiod
schema: 2.0.0
---

# Get-ZNSettingsCloudConnectorFreezePeriod
...
```
Get-ZNSettingsCloudConnectorFreezePeriod [-AccountName <String>] [<CommonParameters>]
```
