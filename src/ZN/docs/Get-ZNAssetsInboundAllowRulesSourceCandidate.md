...
online version: https://github.com/zeronetworkszeronetworks/get-znassetsinboundallowrulessourcecandidate
schema: 2.0.0
---

# Get-ZNAssetsInboundAllowRulesSourceCandidate
...
```
Get-ZNAssetsInboundAllowRulesSourceCandidate -AssetId <String> [-Cursor <Int64>] [-Limit <Int32>]
...
### Example 1: List source candidates for inbound allow rule for a specific asset
```powershell
(Get-ZNAssetsInboundAllowRulesSourceCandidate -AssetId 'a:a:OtfLGUBq').Items
```
...
### Example 2: Search for a source candidate
```powershell
(Get-ZNAssetsInboundAllowRulesSourceCandidate -AssetId 'a:a:OtfLGUBq' -Search DC01).Items
```
