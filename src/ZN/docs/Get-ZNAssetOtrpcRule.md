...
online version: https://github.com/zeronetworkszeronetworks/get-znassetotrpcrule
schema: 2.0.0
---
...
### List (Default)
```
Get-ZNAssetOtrpcRule -AssetId <String> [-AddAncestors] [-AddBuiltins] [-Filters <String>] [-Limit <Int32>]
 [-Offset <Int32>] [-WithCount] [<CommonParameters>]
```

### Get
```
Get-ZNAssetOtrpcRule -AssetId <String> -RuleId <String> [<CommonParameters>]
```
...
### Example 1: List RPC Rules for a specific asset
```powershell
(Get-ZNAssetOtrpcRule -AssetId 'a:t:itN4uaLX').Items
```
...
This cmdlet lists the RPC Rules for a specific asset.

### Example 2: Get a RPC Rule for a specific asset
```powershell
Get-ZNAssetOtrpcRule -AssetId 'a:t:itN4uaLX' -RuleId '9d607d06-73cf-4ab6-a9dc-0ccf72e146f3'
```
...
This cmdlet gets a RPC Rule for a specific asset.
