...
online version: https://github.com/zeronetworkszeronetworks/new-znassetinboundblockrule
schema: 2.0.0
---
...
```
New-ZNAssetInboundBlockRule -AssetId <String> -LocalEntityId <String> -LocalProcessesList <String[]>
