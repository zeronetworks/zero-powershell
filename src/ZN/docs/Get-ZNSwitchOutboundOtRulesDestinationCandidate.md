...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znswitchoutboundotrulesdestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNSwitchOutboundOtRulesDestinationCandidate -SwitchId <String> [-AccountName <String>] [-Limit <Int32>]
...
```powershell
(Get-ZNSwitchOutboundOtRulesDestinationCandidate -SwitchId w:c:IBlczUkw).Items
```
...
This cmdlet list destination candidates for an outbound OT rule.
