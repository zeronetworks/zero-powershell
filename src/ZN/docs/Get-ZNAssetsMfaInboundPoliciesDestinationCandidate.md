...
online version: https://github.com/zeronetworkszeronetworks/get-znassetsmfainboundpoliciesdestinationcandidate
schema: 2.0.0
---

# Get-ZNAssetsMfaInboundPoliciesDestinationCandidate
...
```
Get-ZNAssetsMfaInboundPoliciesDestinationCandidate -AssetId <String> [-Limit <Int32>] [-Offset <Int32>]
