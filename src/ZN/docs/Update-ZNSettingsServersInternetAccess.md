...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znsettingsserversinternetaccess
schema: 2.0.0
---

# Update-ZNSettingsServersInternetAccess
...
```
Update-ZNSettingsServersInternetAccess [-AccountName <String>] [-Trusted <IPortsListItem[]>]
