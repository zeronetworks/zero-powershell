...
online version: https://github.com/zeronetworks/zero-powershell/Deny-ZNAssetsInboundAllowRuleReview
schema: 2.0.0
---

# Deny-ZNAssetsInboundAllowRuleReview
...
```
Deny-ZNAssetsInboundAllowRuleReview -AssetId <String> -RuleId <String> -Reason <Object> [-Details <String>]
