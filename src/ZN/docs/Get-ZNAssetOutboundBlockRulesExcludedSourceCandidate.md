...
online version: https://github.com/zeronetworkszeronetworks/get-znassetoutboundblockrulesexcludedsourcecandidate
schema: 2.0.0
---
...
```
Get-ZNAssetOutboundBlockRulesExcludedSourceCandidate -AssetId <String> [-Cursor <Int64>] [-Limit <Int32>]
...
(Get-ZNAssetOutboundBlockRulesExcludedSourceCandidate -AssetId $asset).Items
```
