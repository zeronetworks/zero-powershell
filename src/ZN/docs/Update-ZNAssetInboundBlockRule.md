...
online version: https://github.com/zeronetworks/zero-powershell/update-znassetinboundblockrule
schema: 2.0.0
---
...
```
Update-ZNAssetInboundBlockRule -AssetId <String> -RuleId <String> [-Description <String>]
