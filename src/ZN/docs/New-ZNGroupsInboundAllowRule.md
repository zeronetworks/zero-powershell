...
online version: https://github.com/zeronetworkszeronetworks/new-zngroupsinboundallowrule
schema: 2.0.0
---
...
```
New-ZNGroupsInboundAllowRule -GroupId <String> -GroupType <String> -LocalEntityId <String>
...
New-ZNGroupsInboundAllowRule -GroupId $group.id -GroupType tag -LocalEntityId $group.Id -LocalProcessesList @("*") -PortsList $portsList -RemoteEntityIdsList @($sourceAsset) -State 1
```
