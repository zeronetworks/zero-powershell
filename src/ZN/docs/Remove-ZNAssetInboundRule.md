...
online version: https://github.com/zeronetworkszeronetworks/remove-znassetinboundrule
schema: 2.0.0
---
...
```
Remove-ZNAssetInboundRule -AssetId <String> -RuleId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
