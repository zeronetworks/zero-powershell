...
online version: https://github.com/zeronetworks/zero-powershell/Approve-ZNAssetInboundBlockRuleReview
schema: 2.0.0
---
...
```
Approve-ZNAssetInboundBlockRuleReview -AssetId <String> -RuleId <String> [-AsJob] [-NoWait] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ApproveWithChangesExpanded
```
Approve-ZNAssetInboundBlockRuleReview -AssetId <String> -RuleId <String> -Reason <Object>
