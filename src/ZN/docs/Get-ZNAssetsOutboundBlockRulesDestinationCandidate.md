...
online version: https://github.com/zeronetworkszeronetworks/get-znassetsoutboundblockrulesdestinationcandidate
schema: 2.0.0
---

# Get-ZNAssetsOutboundBlockRulesDestinationCandidate
...
```
Get-ZNAssetsOutboundBlockRulesDestinationCandidate -AssetId <String> [-Cursor <Int64>] [-Limit <Int32>]
...
### Example 1: Get possible destinations for outbound block rule for a specific asset
```powershell
(Get-ZNAssetsOutboundBlockRulesDestinationCandidate -AssetId 'a:a:OtfLGUBq').Items
```
...
```powershell
(Get-ZNAssetsOutboundBlockRulesDestinationCandidate -AssetId 'a:a:OtfLGUBq' -Search DC01).Items
```
