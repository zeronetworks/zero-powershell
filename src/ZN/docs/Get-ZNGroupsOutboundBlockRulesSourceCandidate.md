...
online version: https://github.com/zeronetworkszeronetworks/get-zngroupsoutboundblockrulessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNGroupsOutboundBlockRulesSourceCandidate -GroupId <String> -GroupType <String> [-Cursor <Int64>]
...
(Get-ZNGroupsOutboundBlockRulesSourceCandidate -Groupid $group.id -GroupType tag).Items        
```
