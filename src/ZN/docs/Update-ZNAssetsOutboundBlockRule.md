...
online version: https://github.com/zeronetworks/zero-powershell/update-znassetsoutboundblockrule
schema: 2.0.0
---

# Update-ZNAssetsOutboundBlockRule
...
```
Update-ZNAssetsOutboundBlockRule -AssetId <String> -RuleId <String> [-Description <String>]
...
### Example 1: Update outbound block rule for an Asset
```powershell
$asset = Search-ZNAsset -fqdn linux0.posh.local
Update-ZNAssetsOutboundBlockRule -AssetId $asset -RuleId '62a5599c-dcaf-4e7f-9527-021fde3d29d3' -Description "New Description"
```
...
This cmdlet updates an outbound block rule for an asset.
