...
online version: https://github.com/zeronetworkszeronetworks/get-znassetinboundblockrulesexcludeddestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNAssetInboundBlockRulesExcludedDestinationCandidate -AssetId <String> [-Cursor <Int64>] [-Limit <Int32>]
...
### Example 1: Get excluded destination candidates for an rule for a specific asset
```powershell
$asset = Search-ZNAsset -Fqdn dc01.posh.local
(Get-ZNAssetInboundBlockRulesExcludedDestinationCandidate -AssetId $asset).Items
...
This cmdlet gets the possible excluded destination candidates for a rule for a specific asset.
