...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/new-znassetotinboundotrule
schema: 2.0.0
---
...
```
New-ZNAssetOtInboundOtrule -AssetId <String> -Action <Int32> -LocalEntityId <String>
