...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znassetoutboundotrulessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNAssetOutboundOtRulesSourceCandidate -AssetId <String> [-AccountName <String>] [-Cursor <Int64>]
...
(Get-ZNAssetOutboundOtRulesSourceCandidate -AssetId $asset).Items
```
