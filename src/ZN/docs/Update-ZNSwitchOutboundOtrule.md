...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znswitchoutboundotrule
schema: 2.0.0
---
...
```
Update-ZNSwitchOutboundOtrule -RuleId <String> -SwitchId <String> [-AccountName <String>] [-Action <String>]
