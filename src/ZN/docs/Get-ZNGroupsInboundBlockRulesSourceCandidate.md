...
online version: https://github.com/zeronetworkszeronetworks/get-zngroupsinboundblockrulessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNGroupsInboundBlockRulesSourceCandidate -GroupId <String> -GroupType <String> [-Cursor <Int64>]
...
(Get-ZNGroupsInboundBlockRulesSourceCandidate -Groupid $group.id -GroupType tag).Items             
