...
online version: https://github.com/zeronetworkszeronetworks/get-znassetsmfaoutboundpoliciessourcecandidate
schema: 2.0.0
---

# Get-ZNAssetsMfaOutboundPoliciesSourceCandidate
...
```
Get-ZNAssetsMfaOutboundPoliciesSourceCandidate -AssetId <String> [-Limit <Int32>] [-Offset <Int32>]
...
```powershell
(Get-ZNAssetsMfaInboundPoliciesSourceCandidate -AssetId 'a:a:OtfLGUBq' -Search DC01).Items
```
