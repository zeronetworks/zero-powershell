...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znsettingscloudconnectorfreezeperiod
schema: 2.0.0
---

# Update-ZNSettingsCloudConnectorFreezePeriod
...
```
Update-ZNSettingsCloudConnectorFreezePeriod -FreezePeriodId <String> [-AccountName <String>]
