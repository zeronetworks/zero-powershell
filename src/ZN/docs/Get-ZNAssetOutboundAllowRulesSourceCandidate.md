...
online version: https://github.com/zeronetworkszeronetworks/get-znassetoutboundallowrulessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNAssetOutboundAllowRulesSourceCandidate -AssetId <String> [-Cursor <Int64>] [-Limit <Int32>]
...
(Get-ZNAssetOutboundAllowRulesSourceCandidate -AssetId $asset).Items        
