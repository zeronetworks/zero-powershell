...
online version: https://github.com/zeronetworks/zero-powershell/Deny-ZNAssetOutboundBlockRuleReview
schema: 2.0.0
---
...
```
Deny-ZNAssetOutboundBlockRuleReview -AssetId <String> -RuleId <String> -Reason <Object> [-Details <String>]
