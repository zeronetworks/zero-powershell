...
online version: https://github.com/zeronetworks/zero-powershell/Approve-ZNAssetOutboundAllowRuleReview
schema: 2.0.0
---
...
```
Approve-ZNAssetOutboundAllowRuleReview -AssetId <String> -RuleId <String> [-AsJob] [-NoWait] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ApproveWithChangesExpanded
```
Approve-ZNAssetOutboundAllowRuleReview -AssetId <String> -RuleId <String> -Reason <Object>
