...
online version: https://github.com/zeronetworkszeronetworks/get-zngroupsoutboundallowrulesexcludedsourcecandidate
schema: 2.0.0
---
...
```
Get-ZNGroupsOutboundAllowRulesExcludedSourceCandidate -GroupId <String> -GroupType <String> [-Cursor <Int64>]
...
(Get-ZNGroupsOutboundAllowRulesExcludedSourceCandidate -Groupid $group.id -GroupType tag).Items
```
