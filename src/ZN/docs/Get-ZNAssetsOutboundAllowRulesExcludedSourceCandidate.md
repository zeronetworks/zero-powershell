...
online version: https://github.com/zeronetworkszeronetworks/get-znassetsoutboundallowrulesexcludedsourcecandidate
schema: 2.0.0
---

# Get-ZNAssetsOutboundAllowRulesExcludedSourceCandidate
...
```
Get-ZNAssetsOutboundAllowRulesExcludedSourceCandidate -AssetId <String> [-Cursor <Int64>] [-Limit <Int32>]
