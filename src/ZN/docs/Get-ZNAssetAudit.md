...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znassetaudit
schema: 2.0.0
---
...
```
Get-ZNAssetAudit -AssetId <String> [-AccountName <String>] [-Cursor <Int64>] [-Filters <String>]
