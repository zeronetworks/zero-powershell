...
online version: https://github.com/zeronetworkszeronetworks/get-znuserrulesdistribution
schema: 2.0.0
---
...
```
Get-ZNUserRulesDistribution -RuleId <String> -UserId <String> -RuleDirection <Int32> [<CommonParameters>]
```
