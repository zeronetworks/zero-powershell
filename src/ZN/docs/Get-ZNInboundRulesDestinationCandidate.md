...
online version: https://github.com/zeronetworkszeronetworks/get-zninboundrulesdestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNInboundRulesDestinationCandidate [-Cursor <String>] [-Limit <Int32>] [-Search <String>]
 [<CommonParameters>]
```
