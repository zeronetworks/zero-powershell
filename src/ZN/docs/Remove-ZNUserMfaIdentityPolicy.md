...
online version: https://github.com/zeronetworkszeronetworks/remove-znusermfaidentitypolicy
schema: 2.0.0
---
...
```
Remove-ZNUserMfaIdentityPolicy -ReactivePolicyId <String> -UserId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
