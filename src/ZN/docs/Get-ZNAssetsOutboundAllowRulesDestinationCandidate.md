...
online version: https://github.com/zeronetworkszeronetworks/get-znassetsoutboundallowrulesdestinationcandidate
schema: 2.0.0
---

# Get-ZNAssetsOutboundAllowRulesDestinationCandidate
...
```
Get-ZNAssetsOutboundAllowRulesDestinationCandidate -AssetId <String> [-Cursor <Int64>] [-Limit <Int32>]
...
### Example 1: Get possible destinations for outbound allow rule for a specific asset
```powershell
(Get-ZNAssetsOutboundAllowRulesDestinationCandidate -AssetId 'a:a:OtfLGUBq').Items
```
...
```powershell
(Get-ZNAssetsOutboundAllowRulesDestinationCandidate -AssetId 'a:a:OtfLGUBq' -search DC01).Items
```
