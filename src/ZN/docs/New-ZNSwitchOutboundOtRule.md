...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/new-znswitchoutboundotrule
schema: 2.0.0
---
...
```
New-ZNSwitchOutboundOtRule -SwitchId <String> -Action <Int32> -Direction <Int32> -LocalEntityId <String>
