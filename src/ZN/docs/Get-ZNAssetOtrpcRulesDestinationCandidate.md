...
online version: https://github.com/zeronetworkszeronetworks/get-znassetotrpcrulesdestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNAssetOtrpcRulesDestinationCandidate -AssetId <String> [-Cursor <Int64>] [-Limit <Int32>]
...
```powershell
(Get-ZNAssetOtrpcRulesDestinationCandidate -AssetId 'a:t:itN4uaLX').Items
```
