...
online version: https://github.com/zeronetworkszeronetworks/new-znadsetting
schema: 2.0.0
---
...
```
New-ZNAdSetting -ActiveDirectoryInfoDomainControllerFqdn <String> -ActiveDirectoryInfoDomainName <String>
