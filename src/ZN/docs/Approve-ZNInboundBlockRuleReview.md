...
online version: https://github.com/zeronetworks/zero-powershell/Approve-ZNInboundBlockRuleReview
schema: 2.0.0
---
...
```
Approve-ZNInboundBlockRuleReview -RuleId <String> [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ApproveWithChangesExpanded
```
Approve-ZNInboundBlockRuleReview -RuleId <String> -Reason <Object> [-Description <String>] [-Details <String>]
