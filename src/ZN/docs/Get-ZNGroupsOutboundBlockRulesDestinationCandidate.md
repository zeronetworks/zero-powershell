...
online version: https://github.com/zeronetworkszeronetworks/get-zngroupsoutboundblockrulesdestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNGroupsOutboundBlockRulesDestinationCandidate -GroupId <String> -GroupType <String> [-Cursor <Int64>]
...
(Get-ZNGroupsOutboundBlockRulesDestinationCandidate -Groupid $group.id -GroupType tag).Items

Domain     HasProtectionPolicy Id           Name
------     ------------------- --           ----
                               g:s:23445453 Untrusted Internet
