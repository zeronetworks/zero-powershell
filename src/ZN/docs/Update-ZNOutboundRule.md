...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znoutboundrule
schema: 2.0.0
---
...
```
Update-ZNOutboundRule -RuleId <String> [-AccountName <String>] [-Action <String>] [-Description <String>]
