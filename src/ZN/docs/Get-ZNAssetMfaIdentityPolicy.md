...
### List (Default)
```
Get-ZNAssetMfaIdentityPolicy -AssetId <String> [-AddAncestors] [-AddBuiltins] [-Filters <String>]
...
### Get
```
Get-ZNAssetMfaIdentityPolicy -AssetId <String> -ReactivePolicyId <String> [<CommonParameters>]
```
