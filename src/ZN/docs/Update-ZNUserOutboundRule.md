...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znuseroutboundrule
schema: 2.0.0
---
...
```
Update-ZNUserOutboundRule -RuleId <String> -UserId <String> [-AccountName <String>] [-Action <String>]
 ...
 [-RemoteEntityIdsList <String[]>] [-ServicesList <String[]>] [-SrcUsersList <SrcUsersListItem[]>]
...
`SRCUSERSLIST <SrcUsersListItem[]>`: the source user(s).
  - `[Id <String>]`: 
  - `[Sid <String>]`: 
