...
online version: https://github.com/zeronetworks/zero-powershell/update-znassetsoutboundallowrule
schema: 2.0.0
---

# Update-ZNAssetsOutboundAllowRule
...
```
Update-ZNAssetsOutboundAllowRule -AssetId <String> -RuleId <String> [-Description <String>]
