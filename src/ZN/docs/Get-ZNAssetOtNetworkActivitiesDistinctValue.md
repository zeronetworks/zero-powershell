...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znassetotnetworkactivitiesdistinctvalue
schema: 2.0.0
---
...
```
Get-ZNAssetOtNetworkActivitiesDistinctValue -AssetId <String> -FieldName <String> [-AccountName <String>]
...
```powershell
(Get-ZNAssetNetworkActivitiesDistinctValue -AssetId $asset -FieldName dstPort).ItemAggregations
```
