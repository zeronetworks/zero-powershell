...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/new-zngroupsinboundotrule
schema: 2.0.0
---
...
```
New-ZNGroupsInboundOtRule -GroupId <String> -GroupType <String> -Action <Int32> -LocalEntityId <String>
 -ProtocolsList <ISwitchProtocolsListBodyItem[]> -ShouldBuildMirrorRules -State <Int32>
 [-AccountName <String>] [-Description <String>] [-Direction <Int32>] [-ExcludedLocalIdsList <String[]>]
