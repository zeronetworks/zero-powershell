...
online version: https://github.com/zeronetworkszeronetworks/get-znassetrpcrulesusercandidate
schema: 2.0.0
---
...
```
Get-ZNAssetRpcRulesUserCandidate -AssetId <String> [-Limit <Int32>] [-Offset <Int32>] [-Search <String>]
 [<CommonParameters>]
```
