...
online version: https://github.com/zeronetworks/zero-powershell/Approve-ZNOutboundBlockRuleReview
schema: 2.0.0
---
...
```
Approve-ZNOutboundBlockRuleReview -RuleId <String> [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ApproveWithChangesExpanded
```
Approve-ZNOutboundBlockRuleReview -RuleId <String> -Reason <Object> [-Description <String>]
...
### Example 1: Approve an outbound block rule
```powershell
