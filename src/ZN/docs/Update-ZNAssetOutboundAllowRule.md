...
online version: https://github.com/zeronetworks/zero-powershell/update-znassetoutboundallowrule
schema: 2.0.0
---
...
```
Update-ZNAssetOutboundAllowRule -AssetId <String> -RuleId <String> [-Description <String>]
...
$rule = Get-ZNAssetOutboundAllowRule -Asset $asset | where {$_.Description -eq "Test Rule"}
$rule.RemoteEntityIdsList += (Search-ZNAsset -Fqdn cs01.posh.local)
Update-ZNAssetOutboundAllowRule -AssetId $asset -RuleId $rule.id -RemoteEntityIdsList $rule.RemoteEntityIdsList
...
ItemActivitiesCount        : 
ItemApprovedAt             : 
ItemCreatedAt              : 1695052971498
ItemDescription            : Test Rule
ItemDirection              : 2
ItemExcludedEntityInfos    : 
ItemExcludedLocalIdsList   : {}
ItemExpiresAt              : 0
ItemId                     : 4731dff7-4a74-4d5e-a217-e7a93687bc51
