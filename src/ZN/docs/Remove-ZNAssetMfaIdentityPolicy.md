...
online version: https://github.com/zeronetworkszeronetworks/remove-znassetmfaidentitypolicy
schema: 2.0.0
---
...
```
Remove-ZNAssetMfaIdentityPolicy -AssetId <String> -ReactivePolicyId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
