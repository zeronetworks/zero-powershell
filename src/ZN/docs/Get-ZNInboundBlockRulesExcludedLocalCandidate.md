...
online version: https://github.com/zeronetworkszeronetworks/get-zninboundblockrulesexcludedlocalcandidate
schema: 2.0.0
---

# Get-ZNInboundBlockRulesExcludedLocalCandidate
...
```
Get-ZNInboundBlockRulesExcludedLocalCandidate [-Cursor <Int64>] [-Limit <Int32>] [-Search <String>]
 [<CommonParameters>]
```
