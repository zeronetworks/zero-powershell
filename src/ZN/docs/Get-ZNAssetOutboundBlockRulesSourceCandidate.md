...
online version: https://github.com/zeronetworkszeronetworks/get-znassetoutboundblockrulessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNAssetOutboundBlockRulesSourceCandidate -AssetId <String> [-Cursor <Int64>] [-Limit <Int32>]
...
(Get-ZNAssetOutboundBlockRulesSourceCandidate -AssetId $asset).Items        
