...
online version: https://github.com/zeronetworkszeronetworks/get-znusersidentitysegmented
schema: 2.0.0
---
...
```
Get-ZNUsersIdentitySegmented [-Filters <String>] [-Limit <Int32>] [-Offset <Int32>] [-Order <String>]
