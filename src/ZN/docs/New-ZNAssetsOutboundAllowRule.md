...
online version: https://github.com/zeronetworkszeronetworks/new-znassetsoutboundallowrule
schema: 2.0.0
---

# New-ZNAssetsOutboundAllowRule
...
```
New-ZNAssetsOutboundAllowRule -AssetId <String> -LocalEntityId <String> -LocalProcessesList <String[]>
