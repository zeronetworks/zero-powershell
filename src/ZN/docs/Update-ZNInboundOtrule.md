...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-zninboundotrule
schema: 2.0.0
---
...
```
Update-ZNInboundOtrule -RuleId <String> [-AccountName <String>] [-Action <String>] [-Description <String>]
...
```powershell
Update-ZNInboundOtrule -RuleId R:s:E19JWHhf -Description "New Description"
```
