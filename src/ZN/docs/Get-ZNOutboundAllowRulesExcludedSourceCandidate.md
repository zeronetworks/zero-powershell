...
online version: https://github.com/zeronetworkszeronetworks/get-znoutboundallowrulesexcludedsourcecandidate
schema: 2.0.0
---
...
```
Get-ZNOutboundAllowRulesExcludedSourceCandidate [-Cursor <Int64>] [-Limit <Int32>] [-Search <String>]
 [<CommonParameters>]
```
