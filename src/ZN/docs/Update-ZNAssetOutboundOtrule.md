...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znassetoutboundotrule
schema: 2.0.0
---
...
```
Update-ZNAssetOutboundOtrule -AssetId <String> -RuleId <String> [-AccountName <String>] [-Action <String>]
 ...
 [-ServicesList <String[]>] [-ShouldBuildMirrorRules <Boolean>] [-SrcUsersList <SrcUsersListItem[]>]
...
`SRCUSERSLIST <SrcUsersListItem[]>`: Source users list
  - `[Id <String>]`: 
  - `[Sid <String>]`: 
