...
online version: https://github.com/zeronetworks/zero-powershell/Approve-ZNAssetsOutboundBlockRuleReview
schema: 2.0.0
---

# Approve-ZNAssetsOutboundBlockRuleReview
...
```
Approve-ZNAssetsOutboundBlockRuleReview -AssetId <String> -RuleId <String> [-AsJob] [-NoWait] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ApproveWithChangesExpanded
```
Approve-ZNAssetsOutboundBlockRuleReview -AssetId <String> -RuleId <String> -Reason <Object>
...
### Example 1: Approve an outbound block rule for a specific asset
```powershell
