...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/tree/master/src/help/zeronetworks/update-znexternalaccesspolicy
schema: 2.0.0
---
...
```powershell
$policy = Get-ZNExternalAccessPolicy -PolicyId 'p:e:diwDLSSB'
Update-ZNExternalAccessPolicy -PolicyId 'p:e:diwDLSSB' -RuleDuration 8
```
