...
external help file:
Module Name: ZN.Api
online version: https://github.com/zn.api/update-zninboundblockrule
schema: 2.0.0
---
...
```
Update-ZNInboundBlockRule -RuleId <String> -LocalEntityId <String> -LocalProcessesList <String[]>
