...
online version: https://github.com/zeronetworks/zero-powershell/Approve-ZNAssetsOutboundAllowRuleReview
schema: 2.0.0
---

# Approve-ZNAssetsOutboundAllowRuleReview
...
```
Approve-ZNAssetsOutboundAllowRuleReview -AssetId <String> -RuleId <String> [-AsJob] [-NoWait] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ApproveWithChangesExpanded
```
Approve-ZNAssetsOutboundAllowRuleReview -AssetId <String> -RuleId <String> -Reason <Object>
...
### Example 1: Approve an outbound allow rule for a specific asset
```powershell
