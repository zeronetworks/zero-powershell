...
online version: https://github.com/zeronetworkszeronetworks/get-znassetinboundrulessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNAssetInboundRulesSourceCandidate -AssetId <String> -RuleType <Int32> [-Cursor <String>] [-Limit <Int32>]
