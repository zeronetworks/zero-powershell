...
online version: https://github.com/zeronetworks/zero-powershell/Deny-ZNInboundAllowRuleReview
schema: 2.0.0
---
...
```
Deny-ZNInboundAllowRuleReview -RuleId <String> -Reason <Object> [-Details <String>] [-AsJob] [-NoWait]
...
### Example 1: Reject a pending inbound allow rule
```powershell
