...
online version: https://github.com/zeronetworkszeronetworks/new-znassetotmfaoutboundpolicy
schema: 2.0.0
---
...
```
New-ZNAssetOtmfaOutboundPolicy -AssetId <String> -AdditionalPortsList <IPortsListItem[]>
