...
online version: https://github.com/zeronetworks/zero-powershell/update-znassetsinboundallowrule
schema: 2.0.0
---

# Update-ZNAssetsInboundAllowRule
...
```
Update-ZNAssetsInboundAllowRule -AssetId <String> -RuleId <String> [-Description <String>]
