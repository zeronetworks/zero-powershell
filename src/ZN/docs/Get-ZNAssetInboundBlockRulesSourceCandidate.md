...
online version: https://github.com/zeronetworkszeronetworks/get-znassetinboundblockrulessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNAssetInboundBlockRulesSourceCandidate -AssetId <String> [-Cursor <Int64>] [-Limit <Int32>]
...
(Get-ZNAssetInboundBlockRulesSourceCandidate -AssetId $asset).Items             
```
