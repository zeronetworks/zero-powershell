...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/new-znmfaoutboundpolicy
schema: 2.0.0
---
...
New-ZNMfaOutboundPolicy -AdditionalPortsList <IPortsListItem[]> -DstEntityInfoId <String> -DstPort <String>
 ...
 [-ChangeTicket <String>] [-Description <String>] [-DstProcessNames <String[]>]
