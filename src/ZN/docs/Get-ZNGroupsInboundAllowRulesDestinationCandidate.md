...
online version: https://github.com/zeronetworkszeronetworks/get-zngroupsinboundallowrulesdestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNGroupsInboundAllowRulesDestinationCandidate -GroupId <String> -GroupType <String> [-Cursor <Int64>]
...
(Get-ZNGroupsInboundAllowRulesDestinationCandidate -Groupid $group.id -GroupType tag).Items
```
