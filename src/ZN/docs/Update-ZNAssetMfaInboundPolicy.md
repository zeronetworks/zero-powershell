...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znassetmfainboundpolicy
schema: 2.0.0
---
...
```
Update-ZNAssetMfaInboundPolicy -AssetId <String> -ReactivePolicyId <String> [-AccountName <String>]
