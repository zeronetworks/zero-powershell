...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/remove-znidentityonboardingpolicy
schema: 2.0.0
---
...
```
Remove-ZNIdentityOnboardingPolicy -ProtectionPolicyId <String> [-AccountName <String>] [-PassThru] [-Confirm]
