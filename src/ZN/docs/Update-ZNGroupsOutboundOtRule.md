...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-zngroupsoutboundotrule
schema: 2.0.0
---
...
```
Update-ZNGroupsOutboundOtRule -GroupId <String> -GroupType <String> -RuleId <String> [-AccountName <String>]
 [-Action <String>] [-Description <String>] [-ExcludedLocalIdsList <String[]>] [-ExpiresAt <Int64>]
 [-LocalEntityId <String>] [-ProtocolsList <SwitchProtocolsListBodyItem[]>] [-RemoteEntitiesIdList <String[]>]
...
Update-ZNGroupsOtOutboundOtrule -GroupId a:t:ffPDi031 -groupType ot -RuleId R:s:v707Sd2y -Description "New Description"
```
...
### ZeroNetworks.PowerShell.Cmdlets.Api.Models.SwitchRuleItem
...
`PROTOCOLSLIST <SwitchProtocolsListBodyItem[]>`: the destination ports and protocols.
  - `[LocalPorts <String>]`: 
  - `[Ports <String>]`: 
