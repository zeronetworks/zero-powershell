...
online version: https://github.com/zeronetworkszeronetworks/get-zngroupsinboundrulesexcludeddestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNGroupsInboundRulesExcludedDestinationCandidate -GroupId <String> -GroupType <String> [-Cursor <String>]
