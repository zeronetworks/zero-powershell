...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/tree/master/src/help/zeronetworks/update-znassetexternalaccesspolicy
schema: 2.0.0
---
...
```
Update-ZNAssetExternalAccessPolicy -AssetId <String> -PolicyId <String> [-AccountName <String>]
