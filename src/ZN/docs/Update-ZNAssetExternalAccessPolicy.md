...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/update-znassetexternalaccesspolicy
schema: 2.0.0
---
...
```
Update-ZNAssetExternalAccessPolicy -AssetId <String> -PolicyId <String> [-Description <String>]
...
```powershell
Update-ZNAssetExternalAccessPolicy -AssetId a:n:3Odw9d40 -PolicyId p:e:JBy1jmUL -Description "Test"
```
