...
online version: https://github.com/zeronetworkszeronetworks/get-zngroupsinboundrule
schema: 2.0.0
---
...
### List (Default)
```
Get-ZNGroupsInboundRule -GroupId <String> -GroupType <String> [-AddAncestors] [-AddBuiltins]
...
### Get
```
Get-ZNGroupsInboundRule -GroupId <String> -GroupType <String> -RuleId <String> [<CommonParameters>]
```
