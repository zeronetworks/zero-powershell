...
online version: https://github.com/zeronetworkszeronetworks/get-znassetsoutboundallowrulessourcecandidate
schema: 2.0.0
---

# Get-ZNAssetsOutboundAllowRulesSourceCandidate
...
```
Get-ZNAssetsOutboundAllowRulesSourceCandidate -AssetId <String> [-Cursor <Int64>] [-Limit <Int32>]
...
### Example 1: Get possible sources for outbound allow rule for a specific asset
```powershell
(Get-ZNAssetsOutboundAllowRulesSourceCandidate -AssetId 'a:a:OtfLGUBq').Items
```
...
```powershell
(Get-ZNAssetsOutboundAllowRulesSourceCandidate -AssetId 'a:a:OtfLGUBq' -Search DC01).Items
```
