...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-znconnectpoliciesassetscandidate
schema: 2.0.0
---

# Get-ZNConnectPoliciesAssetsCandidate
...
```
Get-ZNConnectPoliciesAssetsCandidate [-AccountName <String>] [-Limit <Int32>] [-Offset <Int32>]
