...
online version: https://github.com/zeronetworks/zero-powershell/update-zngroupsoutboundblockrule
schema: 2.0.0
---
...
```
Update-ZNGroupsOutboundBlockRule -GroupId <String> -GroupType <String> -RuleId <String>
