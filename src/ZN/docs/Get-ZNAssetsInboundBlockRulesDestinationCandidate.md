...
online version: https://github.com/zeronetworkszeronetworks/get-znassetsinboundblockrulesdestinationcandidate
schema: 2.0.0
---

# Get-ZNAssetsInboundBlockRulesDestinationCandidate
...
```
Get-ZNAssetsInboundBlockRulesDestinationCandidate -AssetId <String> [-Limit <Int32>] [-Offset <Int32>]
...
### Example 1: Get possible destinations for inbound block rule for a specific asset
```powershell
(Get-ZNAssetsInboundBlockRulesDestinationCandidate -AssetId 'a:a:OtfLGUBq').Items
```
...
```powershell
(Get-ZNAssetsInboundBlockRulesDestinationCandidate -AssetId 'a:a:OtfLGUBq' -Search DC1).Items
```
