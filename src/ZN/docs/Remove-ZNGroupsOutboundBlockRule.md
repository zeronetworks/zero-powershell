...
online version: https://github.com/zeronetworkszeronetworks/remove-zngroupsoutboundblockrule
schema: 2.0.0
---
...
```
Remove-ZNGroupsOutboundBlockRule -GroupId <String> -GroupType <String> -RuleId <String> [-PassThru] [-Confirm]
