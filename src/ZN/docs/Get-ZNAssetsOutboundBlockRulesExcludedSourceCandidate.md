...
online version: https://github.com/zeronetworkszeronetworks/get-znassetsoutboundblockrulesexcludedsourcecandidate
schema: 2.0.0
---

# Get-ZNAssetsOutboundBlockRulesExcludedSourceCandidate
...
```
Get-ZNAssetsOutboundBlockRulesExcludedSourceCandidate -AssetId <String> [-Cursor <Int64>] [-Limit <Int32>]
...
### Example 1: Get possible sources to exclude for outbound block rule for a specific asset
```powershell
(Get-ZNAssetsOutboundBlockRulesExcludedSourceCandidate -AssetId 'a:a:OtfLGUBq').Items
```
...
```powershell
(Get-ZNAssetsOutboundBlockRulesExcludedSourceCandidate -AssetId 'a:a:OtfLGUBq' -Search DC01).Items
```
