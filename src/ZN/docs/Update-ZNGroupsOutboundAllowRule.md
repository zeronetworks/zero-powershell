...
online version: https://github.com/zeronetworks/zero-powershell/update-zngroupsoutboundallowrule
schema: 2.0.0
---
...
```
Update-ZNGroupsOutboundAllowRule -GroupId <String> -GroupType <String> -RuleId <String>
...
$rule = Get-ZNGroupsOutboundAllowRule -GroupId $group.Id -GroupType Tag | where {$_.Description -eq "Test Rule"}
$rule.RemoteEntityIdsList += (Search-ZNAsset -Fqdn cs01.posh.local)
Update-ZNGroupsOutboundAllowRule -GroupId $group.Id -GroupType tag -RuleId $rule.id -RemoteEntityIdsList $rule.RemoteEntityIdsList
