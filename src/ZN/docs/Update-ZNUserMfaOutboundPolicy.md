...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znusermfaoutboundpolicy
schema: 2.0.0
---
...
```
Update-ZNUserMfaOutboundPolicy -ReactivePolicyId <String> -UserId <String> [-AccountName <String>]
