...
online version: https://github.com/zeronetworkszeronetworks/get-znassetoutboundallowrulesexcludedsourcecandidate
schema: 2.0.0
---
...
```
Get-ZNAssetOutboundAllowRulesExcludedSourceCandidate -AssetId <String> [-Cursor <Int64>] [-Limit <Int32>]
