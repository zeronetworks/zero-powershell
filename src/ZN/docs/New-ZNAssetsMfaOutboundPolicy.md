...
online version: https://github.com/zeronetworkszeronetworks/new-znassetsmfaoutboundpolicy
schema: 2.0.0
---

# New-ZNAssetsMfaOutboundPolicy
...
```
New-ZNAssetsMfaOutboundPolicy -AssetId <String> -AdditionalPortsList <IPortsListItem[]>
