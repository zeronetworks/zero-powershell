...
online version: https://github.com/zeronetworkszeronetworks/get-zngroupsinboundblockrulesdestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNGroupsInboundBlockRulesDestinationCandidate -GroupId <String> -GroupType <String> [-Limit <Int32>]
...
(Get-ZNGroupsInboundBlockRulesDestinationCandidate -Groupid $group.id -GroupType tag).Items
