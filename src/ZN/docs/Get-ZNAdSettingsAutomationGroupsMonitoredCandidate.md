...
online version: https://github.com/zeronetworkszeronetworks/get-znadsettingsautomationgroupsmonitoredcandidate
schema: 2.0.0
---

# Get-ZNAdSettingsAutomationGroupsMonitoredCandidate
...
```
Get-ZNAdSettingsAutomationGroupsMonitoredCandidate -ForestId <String> [-Limit <Int32>] [-Offset <Int32>]
