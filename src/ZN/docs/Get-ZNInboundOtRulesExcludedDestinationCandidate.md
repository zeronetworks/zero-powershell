...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/get-zninboundotrulesexcludeddestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNInboundOtRulesExcludedDestinationCandidate [-AccountName <String>] [-Cursor <Int64>] [-Limit <Int32>]
...
### Example 1: List excluded destination candidate for OT outbound rule
```powershell
(Get-ZNAssetOtOutboundOtrulesExcludedDestinationCandidate -AssetId a:t:o0AARV78).items
```
...
This cmdlet lists excluded destination candidates for an OT outbound rule.
