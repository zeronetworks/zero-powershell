...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/new-zngroupsexternalaccesspolicy
schema: 2.0.0
---
...
```
New-ZNGroupsExternalAccessPolicy -GroupId <String> -GroupType <String> -DstAssetId <String>
 -DstPortsList <IPortsListItem[]> -DstProcessNamesList <String[]> -Name <String> -RuleDuration <Int32>
 -SrcUserIdsList <String[]> [-AccountName <String>] [-ChangeTicket <String>] [-Description <String>]
 [-State <Int32>] [-Url <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
New-ZNGroupsExternalAccessPolicy -GroupId "g:t:5V669ce2/" -GroupType tag -DstAssetId "g:t:5V669ce2" -DstPortsList $portsList -DstProcessNamesList @("*") -Name "ExternalTest" -RuleDuration 4 -SrcUserIdsList @($srcUser.Id) -State 1 -Url "https://external.posh.local"
```
