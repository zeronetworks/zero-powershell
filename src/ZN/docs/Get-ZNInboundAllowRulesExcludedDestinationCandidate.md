...
online version: https://github.com/zeronetworkszeronetworks/get-zninboundallowrulesexcludeddestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNInboundAllowRulesExcludedDestinationCandidate [-Cursor <Int64>] [-Limit <Int32>] [-Search <String>]
 [<CommonParameters>]
```
