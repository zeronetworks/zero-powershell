...
online version: https://github.com/zeronetworkszeronetworks/get-zngroupsoutboundallowrulessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNGroupsOutboundAllowRulesSourceCandidate -GroupId <String> -GroupType <String> [-Cursor <Int64>]
...
(Get-ZNGroupsOutboundAllowRulesSourceCandidate -Groupid $group.id -GroupType tag).Items        
