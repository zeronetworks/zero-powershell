...
online version: https://github.com/zeronetworkszeronetworks/get-znassetsmfainboundpoliciessourcecandidate
schema: 2.0.0
---

# Get-ZNAssetsMfaInboundPoliciesSourceCandidate
...
```
Get-ZNAssetsMfaInboundPoliciesSourceCandidate -AssetId <String> [-Limit <Int32>] [-Offset <Int32>]
