...
online version: https://github.com/zeronetworkszeronetworks/get-znmfaidentitypoliciessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNMfaIdentityPoliciesSourceCandidate [-Limit <Int32>] [-Offset <Int32>] [-Search <String>]
 [<CommonParameters>]
```
