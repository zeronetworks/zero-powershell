...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/new-znassetotoutboundotrule
schema: 2.0.0
---
...
```
New-ZNAssetOtOutboundOtrule -AssetId <String> -Action <Int32> -LocalEntityId <String>
