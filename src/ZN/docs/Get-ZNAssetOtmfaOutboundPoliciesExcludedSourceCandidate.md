...
online version: https://github.com/zeronetworkszeronetworks/get-znassetotmfaoutboundpoliciesexcludedsourcecandidate
schema: 2.0.0
---
...
```
Get-ZNAssetOtmfaOutboundPoliciesExcludedSourceCandidate -AssetId <String> [-IsSrcAssetUnmonitored]
...
### Example 1: List excluded source candidates for an MFA policy of an OT asset
```powershell
...
This cmdlet returns possible excluded source candidates for an MFA policy for an OT asset.
