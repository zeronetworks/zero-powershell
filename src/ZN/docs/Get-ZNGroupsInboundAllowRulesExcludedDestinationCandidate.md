...
online version: https://github.com/zeronetworkszeronetworks/get-zngroupsinboundallowrulesexcludeddestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNGroupsInboundAllowRulesExcludedDestinationCandidate -GroupId <String> -GroupType <String>
...
(Get-ZNGroupsInboundAllowRulesExcludedDestinationCandidate -Groupid $group.id -GroupType tag).Items 
```
