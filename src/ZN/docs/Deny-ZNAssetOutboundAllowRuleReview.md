...
online version: https://github.com/zeronetworks/zero-powershell/Deny-ZNAssetOutboundAllowRuleReview
schema: 2.0.0
---
...
```
Deny-ZNAssetOutboundAllowRuleReview -AssetId <String> -RuleId <String> -Reason <Object> [-Details <String>]
