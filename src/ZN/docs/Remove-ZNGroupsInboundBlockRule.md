...
online version: https://github.com/zeronetworkszeronetworks/remove-zngroupsinboundblockrule
schema: 2.0.0
---
...
```
Remove-ZNGroupsInboundBlockRule -GroupId <String> -GroupType <String> -RuleId <String> [-PassThru] [-Confirm]
