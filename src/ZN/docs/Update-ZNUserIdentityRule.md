...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znuseridentityrule
schema: 2.0.0
---
...
```
Update-ZNUserIdentityRule -RuleId <String> -UserId <String> [-AccountName <String>] [-Action <Int32>]
