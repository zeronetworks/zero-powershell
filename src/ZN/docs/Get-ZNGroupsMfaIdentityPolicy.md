...
online version: https://github.com/zeronetworkszeronetworks/get-zngroupsmfaidentitypolicy
schema: 2.0.0
---
...
### List (Default)
```
Get-ZNGroupsMfaIdentityPolicy -GroupId <String> -GroupType <String> [-AddAncestors] [-AddBuiltins]
