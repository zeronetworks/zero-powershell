...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/get-zngroupsexternalaccesspolicysourceusercandidate
schema: 2.0.0
---
...
```
Get-ZNGroupsExternalAccessPolicySourceUserCandidate -GroupId <String> -GroupType <String>
...
```powershell
Get-ZNGroupsExternalAccessPolicySourceUserCandidate -Groupid g:t:5V669ce2 -GroupType tag
```
