...
online version: https://github.com/zeronetworks/zero-powershell/zeronetworks/update-znswitchinboundotrule
schema: 2.0.0
---
...
```
Update-ZNSwitchInboundOtrule -RuleId <String> -SwitchId <String> [-AccountName <String>] [-Action <String>]
...
```powershell
Update-ZNSwitchInboundOtrule -SwitchId w:c:IBlczUkw -RuleId R:s:E19JWHhf -Description "New Description"
```
