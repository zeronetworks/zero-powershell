...
online version: https://github.com/zeronetworkszeronetworks/get-znassetoutboundblockrulesdestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNAssetOutboundBlockRulesDestinationCandidate -AssetId <String> [-Cursor <Int64>] [-Limit <Int32>]
...
(Get-ZNAssetOutboundBlockRulesDestinationCandidate -AssetId $asset).Items
```
