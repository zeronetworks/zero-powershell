...
online version: https://github.com/zeronetworkszeronetworks/get-zninboundblockrulesdestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNInboundBlockRulesDestinationCandidate [-Limit <Int32>] [-Offset <Int32>] [-Search <String>]
 [<CommonParameters>]
```
