...
online version: https://github.com/zeronetworkszeronetworks/get-zngroupsinboundblockrulesexcludeddestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNGroupsInboundBlockRulesExcludedDestinationCandidate -GroupId <String> -GroupType <String>
