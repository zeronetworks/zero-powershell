...
online version: https://github.com/zeronetworks/zero-powershell/update-znassetotrpcrule
schema: 2.0.0
---
...
```
Update-ZNAssetOtRpcRule -AssetId <String> -RuleId <String> [-Action <Int32>] [-Description <String>]
