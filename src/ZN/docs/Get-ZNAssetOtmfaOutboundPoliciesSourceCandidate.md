...
online version: https://github.com/zeronetworkszeronetworks/get-znassetotmfaoutboundpoliciessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNAssetOtmfaOutboundPoliciesSourceCandidate -AssetId <String> [-Limit <Int32>] [-Offset <Int32>]
...
### Example 1: List source candidates for an MFA policy of an OT asset
```powershell
...
This cmdlet returns possible source candidates for an MFA policy for an OT asset.
