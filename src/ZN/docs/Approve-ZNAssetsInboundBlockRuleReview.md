...
online version: https://github.com/zeronetworks/zero-powershell/Approve-ZNAssetsInboundBlockRuleReview
schema: 2.0.0
---

# Approve-ZNAssetsInboundBlockRuleReview
...
```
Approve-ZNAssetsInboundBlockRuleReview -AssetId <String> -RuleId <String> [-AsJob] [-NoWait] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### ApproveWithChangesExpanded
```
Approve-ZNAssetsInboundBlockRuleReview -AssetId <String> -RuleId <String> -Reason <Object>
