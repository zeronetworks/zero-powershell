...
online version: https://github.com/zeronetworkszeronetworks/get-znoutboundblockrulesexcludedsourcecandidate
schema: 2.0.0
---
...
```
Get-ZNOutboundBlockRulesExcludedSourceCandidate [-Cursor <Int64>] [-Limit <Int32>] [-Search <String>]
 [<CommonParameters>]
```
