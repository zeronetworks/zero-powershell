...
online version: https://github.com/zeronetworkszeronetworks/get-znassetsinboundallowrulesdestinationcandidate
schema: 2.0.0
---

# Get-ZNAssetsInboundAllowRulesDestinationCandidate
...
```
Get-ZNAssetsInboundAllowRulesDestinationCandidate -AssetId <String> [-Cursor <Int64>] [-Limit <Int32>]
...
### Example 1: Get possible destinations for inbound allow rule for a specifc asset
```powershell
(Get-ZNAssetsInboundAllowRulesDestinationCandidate -AssetId 'a:a:OtfLGUBq').Items
```
...
```powershell
(Get-ZNAssetsInboundAllowRulesDestinationCandidate -AssetId 'a:a:OtfLGUBq' -search DC1).Items
```
