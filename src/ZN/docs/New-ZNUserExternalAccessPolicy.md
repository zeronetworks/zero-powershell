...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/new-znuserexternalaccesspolicy
schema: 2.0.0
---
...
```
New-ZNUserExternalAccessPolicy -UserId <String> -DstAssetId <String> -DstPortsList <IPortsListItem[]>
