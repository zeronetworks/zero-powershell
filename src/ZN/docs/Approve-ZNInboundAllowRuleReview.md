...
```powershell
Approve-ZNInboundAllowRuleReview -RuleId '9d275288-4fc3-46e5-a5a0-ff0626214b87'
...
```powershell
Approve-ZNInboundAllowRuleReview -RuleId 'e4a170be-c192-414a-9d36-380a4483583a' -Description "new description" -Reason "Other" -Details "add description"
