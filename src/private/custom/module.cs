...
// to that Work or Derivative Works thereof, that is intentionally submitted to Licensor for inclusion in the Work by the
...
// of this definition, "submitted" means any form of electronic, verbal, or written communication sent to the Licensor or
// its representatives, including but not limited to communication on electronic mailing lists, source code control systems,
...
// 4. If You institute litigation against any entity (including a cross-claim or counterclaim in a lawsuit) alleging that
// the Work or a Contribution incorporated within the Work constitutes direct or contributory intellectual property infringement,
...
// 5. Redistribution. You may reproduce and distribute copies of the Work or Derivative Works thereof in any medium, with
...
// 6. It is hereby agreed and acknowledged that Contributions to the Work can be made exclusively under the terms of this
// license agreement, free of charge, and any use made in such Contributions by any party, including Licensor, may be made
...
// above, nothing herein shall supersede or modify the terms of any separate license agreement you may have executed with
...
namespace ZeroNetworks.PowerShell.Cmdlets.Api
{
    ...
    public partial class Module
    {
        ...
        {
            var ApiKey = System.Environment.GetEnvironmentVariable("ZNApiKey");
            if ( ApiKey != null)
            {
