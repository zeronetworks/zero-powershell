...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/get-znsettingsconnectuseraccessconfigdestinationscandidate
schema: 2.0.0
---
...
```
Get-ZNSettingsConnectUserAccessConfigDestinationsCandidate [-AccountName <String>] [-Limit <Int32>]
