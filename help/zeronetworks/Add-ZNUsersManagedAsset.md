...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/add-znusersmanagedasset
schema: 2.0.0
---
...
```
Add-ZNUsersManagedAsset -UserId <String> [-AccountName <String>] [-EntityIds <String[]>] [-Permission <Int32>]
