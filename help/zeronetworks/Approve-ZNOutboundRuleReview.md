...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/Approve-ZNOutboundRuleReview
schema: 2.0.0
---
...
```
Approve-ZNOutboundRuleReview -RuleId <String> -Reason <Object> [-Description <String>] [-Details <String>]
