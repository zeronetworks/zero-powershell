...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/get-znoutboundrulesexcludedsourcecandidate
schema: 2.0.0
---
...
```
Get-ZNOutboundRulesExcludedSourceCandidate [-AccountName <String>] [-Cursor <Int64>] [-Limit <Int32>]
...
### Example 1: Get possible destinations to exclude for outbound rule
```powershell
(Get-ZNOutboundRulesExcludedSourceCandidate).Items
```
...
```powershell
(Get-ZNOutboundRulesExcludedSourceCandidate -Search DC1).Items
```
