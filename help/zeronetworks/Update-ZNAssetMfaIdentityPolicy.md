...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/update-znmassetfaidentitypolicy
schema: 2.0.0
---
...
```
Update-ZNAssetMfaIdentityPolicy -AssetId <String> -ReactivePolicyId <String> [-Description <String>]
 ...
 [-RestrictLoginToOriginatingUser] [-RuleDuration <Int32>] [-SrcAssetIdsList <String[]>]
...
Update-ZNAssetMfaIdentityPolicy -AssetId $asset -ReactivePolicyId ec33049b-4e27-4f73-8f6d-8db4f5ff1e59 -Description assettest
```
