...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/get-znoutboundrulessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNOutboundRulesSourceCandidate [-AccountName <String>] [-Cursor <Int64>] [-Limit <Int32>]
...
### Example 1: Get possible sources for outbound rule
```powershell
(Get-ZNOutboundRulesSourceCandidate).Items
```
...
```powershell
(Get-ZNOutboundRulesSourceCandidate -Search DC1).Items
```
