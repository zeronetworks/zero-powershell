...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/get-znassetmfaoutboundpoliciessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNAssetMfaOutboundPoliciesSourceCandidate -AssetId <String> [-AccountName <String>] [-Limit <Int32>]
...
### Example 1: List source candidates for outbound MFA policy for a specific asset.
```powershell
$asset = Search-ZNAsset -Fqdn dc01.posh.local
(Get-ZNAssetMfaOutboundPoliciesSourceCandidate -AssetId $asset).Items
```
...
This cmdlet lists the source candidates for an outbound MFA policy for a specific asset.
