...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/get-znassetmfaidentitypoliciesdestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNAssetMfaIdentityPoliciesDestinationCandidate -AssetId <String> [-AccountName <String>] [-Limit <Int32>]
...
(Get-ZNAssetMfaIdentityPoliciesDestinationCandidate -AssetId $asset.AssetId).Items
```
