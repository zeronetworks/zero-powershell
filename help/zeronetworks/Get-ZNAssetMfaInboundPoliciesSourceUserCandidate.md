...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/get-znassetmfainboundpoliciessourceusercandidate
schema: 2.0.0
---
...
```
Get-ZNAssetMfaInboundPoliciesSourceUserCandidate -AssetId <String> [-AccountName <String>] [-Limit <Int32>]
...
### Example 1: List source user candidates for inbound MFA policy for a specific asset.
```powershell
...
This cmdlet lists the source user candidates for an inbound MFA policy for a specific asset.
