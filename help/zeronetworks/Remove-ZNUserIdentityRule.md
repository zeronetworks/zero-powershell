...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/remove-znuseridentityrule
schema: 2.0.0
---
...
```
Remove-ZNUserIdentityRule -RuleId <String> -UserId <String> [-AccountName <String>] [-PassThru] [-Confirm]
