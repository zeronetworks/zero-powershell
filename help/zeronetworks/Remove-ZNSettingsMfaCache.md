...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/remove-znsettingsmfacache
schema: 2.0.0
---
...
### Example 1: Delete a MFA cache policy
```powershell
