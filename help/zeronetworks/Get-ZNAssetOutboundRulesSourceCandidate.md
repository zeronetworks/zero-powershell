...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/get-znassetoutboundrulessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNAssetOutboundRulesSourceCandidate -AssetId <String> [-AccountName <String>] [-Cursor <Int64>]
