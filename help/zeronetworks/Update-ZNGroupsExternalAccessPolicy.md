...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/update-zngroupsexternalaccesspolicy
schema: 2.0.0
---
...
```
Update-ZNGroupsExternalAccessPolicy -GroupId <String> -GroupType <String> -PolicyId <String>
...
```powershell
Update-ZNGroupsExternalAccessPolicy -GroupId "g:t:5V669ce2" -GroupType tag -PolicyId p:e:JBy1jmUL -Description "Test"
```
