...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/remove-znuserexternalaccesspolicy
schema: 2.0.0
---
...
```
Remove-ZNUserExternalAccessPolicy -PolicyId <String> -UserId <String> [-AccountName <String>] [-PassThru]
