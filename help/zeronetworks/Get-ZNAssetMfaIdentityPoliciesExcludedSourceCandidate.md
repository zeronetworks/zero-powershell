...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/get-znassetmfaidentitypoliciesexcludedsourcecandidate
schema: 2.0.0
---
...
```
Get-ZNAssetMfaIdentityPoliciesExcludedSourceCandidate -AssetId <String> [-AccountName <String>]
