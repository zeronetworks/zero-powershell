...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/get-znusermfaidentitypoliciessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNUserMfaIdentityPoliciesSourceCandidate -UserId <String> [-AccountName <String>] [-Limit <Int32>]
