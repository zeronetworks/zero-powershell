...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/get-znassetidentityrulesusercandidate
schema: 2.0.0
---
...
```
Get-ZNAssetIdentityRulesUserCandidate -AssetId <String> [-AccountName <String>] [-Limit <Int32>]
