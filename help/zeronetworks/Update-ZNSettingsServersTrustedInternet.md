...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/update-znsettingsserverstrustedinternet
schema: 2.0.0
---
...
```
Update-ZNSettingsServersTrustedInternet [-AccountName <String>] [-Ports <IPortsListItem[]>] [-PassThru]
