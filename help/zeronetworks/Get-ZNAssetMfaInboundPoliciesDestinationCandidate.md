...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/get-znassetmfainboundpoliciesdestinationcandidate
schema: 2.0.0
---
...
```
Get-ZNAssetMfaInboundPoliciesDestinationCandidate -AssetId <String> [-AccountName <String>] [-Limit <Int32>]
...
### Example 1: List destination candidates for inbound MFA policy for a specific asset.
```powershell
$asset = Search-ZNAsset -Fqdn dc01.posh.local
(Get-ZNAssetMfaInboundPoliciesDestinationCandidate -AssetId $asset).Items
```
...
This cmdlet lists the destination candidates for an inbound MFA policy for a specific asset.
