...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/new-znidentityrule
schema: 2.0.0
---
...
New-ZNIdentityRule -Action <Int32> -AssetId <String> -IdentityProtectionCategoryList <Int32[]> -State <Int32>
 -UserIdsList <String[]> [-AccountName <String>] [-Description <String>] [-ExcludedAssetIdsList <String[]>]
