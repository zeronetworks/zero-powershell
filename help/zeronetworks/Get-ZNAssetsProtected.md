...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/get-znassetsprotected
schema: 2.0.0
---
...
```
Get-ZNAssetsProtected [-AccountName <String>] [-Cursor <Int64>] [-Filters <String>] [-Limit <Int32>]
