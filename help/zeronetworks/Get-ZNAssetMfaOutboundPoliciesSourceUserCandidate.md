...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/get-znassetmfaoutboundpoliciessourceusercandidate
schema: 2.0.0
---
...
```
Get-ZNAssetMfaOutboundPoliciesSourceUserCandidate -AssetId <String> [-AccountName <String>] [-Limit <Int32>]
...
### Example 1: List source user candidates for outbound MFA policy for a specific asset.
```powershell
