...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/get-znassetmfaidentitypoliciessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNAssetMfaIdentityPoliciesSourceCandidate -AssetId <String> [-AccountName <String>] [-Limit <Int32>]
...
### Example 1: Get Identity MFA Sources Candidates
```powershell
$asset = Search-ZNAsset -Fqdn dc01.posh.local
(Get-ZNAssetMfaIdentityPoliciesSourcesCandidate -AssetId $asset.AssetId).Items
```
...
This cmdlet lists sources candidates for Identity MFA.
