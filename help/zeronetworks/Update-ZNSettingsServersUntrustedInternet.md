...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/update-znsettingsserversuntrustedinternet
schema: 2.0.0
---
...
```
Update-ZNSettingsServersUntrustedInternet [-AccountName <String>] [-Ports <IPortsListItem[]>] [-PassThru]
