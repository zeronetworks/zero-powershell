...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/get-znassetmfainboundpoliciessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNAssetMfaInboundPoliciesSourceCandidate -AssetId <String> [-AccountName <String>] [-Limit <Int32>]
