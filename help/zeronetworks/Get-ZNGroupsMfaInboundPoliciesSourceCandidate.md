...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/get-zngroupsmfainboundpoliciessourcecandidate
schema: 2.0.0
---
...
```
Get-ZNGroupsMfaInboundPoliciesSourceCandidate -GroupId <String> -GroupType <String> [-AccountName <String>]
