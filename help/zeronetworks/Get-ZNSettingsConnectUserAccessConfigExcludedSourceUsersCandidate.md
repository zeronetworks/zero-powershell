...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/get-znsettingsconnectuseraccessconfigexcludedsourceuserscandidate
schema: 2.0.0
---
...
```
Get-ZNSettingsConnectUserAccessConfigExcludedSourceUsersCandidate [-AccountName <String>] [-Limit <Int32>]
