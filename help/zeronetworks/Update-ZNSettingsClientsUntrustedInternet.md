...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/update-znsettingsclientsuntrustedinternet
schema: 2.0.0
---
...
```
Update-ZNSettingsClientsUntrustedInternet [-AccountName <String>] [-Ports <IPortsListItem[]>] [-PassThru]
