...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/remove-znassetmanager
schema: 2.0.0
---
...
```
Remove-ZNAssetManager -AssetId <String> -GroupOrUserId <String> [-AccountName <String>] [-PassThru] [-Confirm]
