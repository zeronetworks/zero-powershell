...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/get-zngroupsoutboundrulesexcludedsourcecandidate
schema: 2.0.0
---
...
```
Get-ZNGroupsOutboundRulesExcludedSourceCandidate -GroupId <String> -GroupType <String> [-AccountName <String>]
...
(Get-ZNGroupsOutboundRulesExcludedSourceCandidate -Groupid $group.id -GroupType tag).Items
```
