...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/Deny-ZNOutboundRuleReview
schema: 2.0.0
---
...
```
Deny-ZNOutboundRuleReview -RuleId <String> -Reason <Object> [-Details <String>] [-AsJob] [-NoWait] [-Confirm]
...
### Example 1: Reject a pending outbound rule
```powershell
