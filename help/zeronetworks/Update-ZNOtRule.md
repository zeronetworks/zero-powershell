...
online version: https://github.com/zeronetworks/zero-powershell/tree/master/src/help/zeronetworks/update-znotrule
schema: 2.0.0
---
...
```
Update-ZNOtRule -RuleId <String> -Action <Int32> -LocalEntityId <String> -State <Int32>
 [-AccountName <String>] [-Description <String>] [-ExcludedLocalIdsList <String[]>]
 [-ProtocolsList <ISwitchProtocolsListItem[]>] [-RemoteEntitiesList <String[]>] [-PassThru] [-Confirm]
